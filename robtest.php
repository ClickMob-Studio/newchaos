...
@media (max-width: 480px) {
    ...
    <script>
// Function to update points and money
function updateHeaderStats(points, money) {
    // Assuming '.points' and '.money' are the classes for points and money display elements
