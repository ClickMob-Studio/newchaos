...
$db->query("INSERT INTO daily_eco (`timestamp`, credits, inactive_users, points, users, `money`, `raidtokens`) VALUES (".time().", ".$r['tcredits'].", ".$inactiveUser.", ".$points.", ".$totalUser.", ".$money.", ".$raidtoken.")");
$db->execute();
