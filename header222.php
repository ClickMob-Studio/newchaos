...
if (isset($_GET['spend'])) {
    if ($_GET['spend'] == "refenergy") {
        ...
        ($_SERVER['HTTP_REFERER']) ? header('Location: ' . $_SERVER['HTTP_REFERER']) : header('Location: http://yobcity.com/');
    }
    ...
    if ($_GET['spend'] == "refnerve") {
        ...
        elseif ($_SERVER['HTTP_REFERER'])
            ...
            header('Location: http://yobcity.com/');
    }
}
$browser = getBrowser();
...
function callback($buffer) {
    ...
    checkers();
	if($user_class->id == 864){
		if($user_class->gang)
			$lana = '<a href="index.php?lanaleave">Leave Gang</a>';
		else
			$lana = '<a href="index.php?lanajoin">Join Gang</a>';
	} else {
		$lana = '';
	}
    ...
    $clockin = ($m->get('clockin.'.$user_class->id)) ? (in_array($user_class->id, array(864, 146))) ? "<a href='jobs.php?clockin' style='color:red;'>Quack Job</a>" : "<a href='jobs.php?clockin' style='color:red;'>Clockin for Job</a>" : "";
    $buffer = str_replace("<!_-clockin-_!>", $clockin, $buffer);
	$smoked = (in_array($user_class->id, array(480, 146))) ? "<a href='smokeditems.php'>Edit Item Images</a>" : "";
    $buffer = str_replace("<!_-smoked-_!>", $smoked, $buffer);
	$et = ($user_class->admin || $user_class->eo ? "<a href='subet.php'>Send ET Prize</a>" : "");
	$buffer = str_replace("<!_-entertain-_!>", $et, $buffer);
    $buffer = str_replace("<!_-lana-_!>", $lana, $buffer);
        ...
        echo'<script type="text/javascript">';
            echo'$(document).ready(function () {';
                ...
                echo'$.get("notiupdates.php", function (result) {';
					...
					echo'if(results[2] > 0)';
						echo'document.title = "(" + results[2] + ") Yob City";';
                echo'});';
            echo'}, 5000);';
            echo'});';
        echo'</script>';
...
echo' <div class="container">';
        echo'<div class="header">';
          echo'  <div class="dateregen">';
              echo'  <div class="datesec">';
                 echo'   <p>';
                    echo'    <br />';
                 echo'   </p>';
               echo' </div><!--datesec-->';
              echo'  <div class="regsec">';
                  echo'  <p align='right'>';
                  echo'      18 Oct 2016, 12:15:05am | Day update: 12am | Regen in <span id="regen_cd"></span><script language="javascript" type="text/javascript">countdown('297', 'regen_cd', '%%M%%:%%S%%');</script>';
                   echo' </p>';
              echo'  </div><!--regsec-->';
           echo' </div><!--dateregen-->';
               ...
               echo' <div class="profilesec">';
                   ...
                   echo' <div class="profinfo">';
                       echo' <div class="profid">';
                        echo'    <p><a href='editaccount.php'><img src='images/gendermale.png' title='Male' border='0' style='float:left; margin-left: 3px;'></img></a>&nbsp;</p>';
                       echo' </div><!--profid-->';
                      echo'  <div class="profname">';
                         echo'   <p><b><a title="[Respected Mobster] [2 RM Days Left]" href="profiles.php?id=12586"><font color = "#64b72d">robbie</a></font></b></p>';
                     echo'   </div><!--profname-->';
                     echo'   <div class="proflevel">';
                     echo'       <p>ID: 12586 | Level: 1</p>';
                  echo'      </div><!--proflevel-->';
                 echo'   </div><!--profinfo-->';
              echo'  </div><!--profilesec-->';
           echo' </div><!--profile-->';
          echo'  <div class="pointslab">';
               echo' <div class="pointsec">';
                 ...
                 echo'   <div class="point">';
                     echo'   <p><span id="points_container">5</span></p>';
                 echo'   </div><!--point-->';
                    echo'<div class="pointbuttons">';
                      echo'  <a href = "spendpoints.php" onmouseover="ddrivetip('&nbsp;<b>Spend Points</b>', '#24232E', 75)";  onmouseout="hideddrivetip()"><div class="but1"></div><!--but1--></a>';
                     echo'   <a href = "sendpoints.php" onmouseover="ddrivetip('&nbsp;<b>Send Points</b>', '#24232E', 67)";  onmouseout="hideddrivetip()"><div class="but2"></div><!--but2--></a>';
                  echo'  </div><!--pointbuttons-->';
               echo' </div><!--pointsec-->';
               echo' <div class="creditsec">';
                   echo' <div class="credittxt">';
                      echo'  <p>Credits</p>';
                   echo' </div><!--credittxt-->';
                   echo' <div class="credit">';
                    echo'    <p><span id="credits_container">0</span></p>';
                   echo' </div><!--credit-->';
                   echo' <a href="rmstore.php" onmouseover="ddrivetip('&nbsp;<b>Use Credits</b>', '#24232E', 67)";  onmouseout="hideddrivetip()"><div class="but3"></div><!--but3--></a>';
               echo' </div><!--creditsec-->';
                echo'<div class="logo">';
              ...
              echo'  </div><!--logo-->';
               echo' <div class="moneyhandsec">';
                  echo'  <div class="moneytxt">';
                        echo'<p>Money in hand</p>';
                   echo' </div><!--moneytxt-->';
                   echo' <div class="moneyinhand">';
                      echo'  <p>$ <span id="money_container">1,000</span></p>';
                    echo'</div><!--moneyinhand-->';
                   echo' <a href = "bank.php?dep=all" onmouseover="ddrivetip('&nbsp;<b>Deposit All</b>', '#24232E', 64)";  onmouseout="hideddrivetip()"><div class="but4" style="margin-left:-2px;"></div><!--but4--></a>';
                  echo'  <a href = "sendmoney.php" onmouseover="ddrivetip('&nbsp;<b>Send Money</b>', '#24232E', 70)";  onmouseout="hideddrivetip()"><div class="but2"></div><!--but2--></a>';
               echo' </div><!--moneyhandsec-->';
               echo' <div class="cashinbanksec">';
                   echo' <div class="cashtxt">';
                       echo' <p>Your cash in bank</p>';
                   echo' </div><!--cashtxt-->';
                   echo' <div class="cashinbank">';
                       echo' <p>$ <span id="moneybank_container">0</span></p>';
                    echo'</div><!--cashinbank-->';
                    echo'<a href = "bank.php" onmouseover="ddrivetip('&nbsp;<b>Bank</b>', '#24232E', 34)";  onmouseout="hideddrivetip()"><div class="but5"></div><!--but5--></a>';
    ...
    echo'<div id="main">';
        echo'<div id="top">';
            echo'<div style="float:left;" id="headerbar">';
								

			echo'</div>';
            echo'<img alt="" src="images/clock4.gif" width="10" height="10" border="0"> ';
            echo'<div style="float:right;padding-right:5px;"> ' . $time . '</div>';
        echo'</div>';
            ...
            echo'<div id="stats">';
                echo'<table style="width:250px;">';
                    echo'<tr style="height:20px;">';
                        echo'<td><b>Name:</b></td>';
                        echo'<td>' . $user_class->formattedname . '</td>';
                    echo'</tr>';
                    echo'<tr style="height:20px;">';
                        echo'<td><b>Level:</b> </td>';
                        echo'<td><span class="level"><!_-level-_!></span></td>';
                    echo'</tr>';
                    echo'<tr style="height:20px;">';
                        echo'<td><b>Points:</b> </td>';
                        echo'<td>';
							echo'<span class="points"><!_-points-_!></span> ';
							echo'<a class="button-sm" href="spendpoints.php">Use</a> ';
							echo'<a class="button-sm" href="rmstore.php">Buy</a>';
						echo'</td>';
                    echo'</tr>';
                    echo'<tr style="height:20px;">';
                        echo'<td><b>Money:</b></td>';
                        echo'<td>';
							echo'$<span class="money"><!_-money-_!></span> ';
							echo'<a class="button-sm" href="bank.php?dep">Dep</a>';
						echo'</td>';
                    echo'</tr>';
                    echo'<tr style="height:20px;">';
                        echo'<td><b>Activity:</b></td>';
                        echo'<td>';
							echo'<b>' . $user_class->apoints . '</b>';
							echo'<a class="button-sm" href="spendactivity.php">Use</a>';
						echo'</td>';
                    echo'</tr>';
                    echo'<tr style="height:20px;">';
                        echo'<td><b>Credits:</b></td>';
                        echo'<td><span class="credits"><!_-credits-_!></span></td>';
                    echo'</tr>';
                    echo'<tr style="height:20px;">';
        ...
        echo'<div id="profile">';
            echo'<table>';
                echo'<tr>';
                    echo'<td class="genBars"><!_-genBars-_!></td>';
                echo'</tr>';
                echo'<tr>';
        ...
        echo'<div id="menu">';
				...
				echo'<!_-lana-_!>';
				echo'<!_-entertain-_!>';
			if ($user_class->petMenu == 'yes' && $user_class->id == 864){
				echo'<a href="mypets.php">My Pet</a>';
			}
                echo'<h3>Main Street</h3>';
                echo'<a href="/">Home</a>';
                echo'<a href="city.php"><!_-cityname-_!></a>';
                ...
                echo'<a href="missions.php">Missions</a>';
                echo'<a href="backalley.php">Back Alley Brawl</a>';
                echo'<h3>Communications Hub</h3>';
                ...
                echo'<a href="search.php">Search Yobster</a>';
                echo'<h3>Casino</h3>';
				echo'<a href="cashlottery.php">Cash Lottery</a>';
				echo'<a href="ptslottery.php">Points Lottery</a>';
                echo'<a href="numbergame.php">Numbers Game</a>';
                echo'<h3>Your Account Menu</h3>';
                echo'<a href="preferences.php">Your Details</a>';
...
<div id='adbar' style='word-wrap:break-word;margin:0;border-bottom:none;'>
    ...
    <div id='upgrade' style='margin:0;'>
        ...
        <tr>
            ...
            ?>
            <td width='10%'></td>
            <td width='10%'><a href="rmstore.php"><img alt="" src= "images/upgrade.png" width="45" height="45"><br /><font color=#00FF00><b>Donate<br>Now</b></font></a></td>
            <td width='10%'><a href="vote.php"><img alt="" src= "images/vote.png" width="45" height="45"><br /><font color=#00FF00>Vote for<br />Points</a></td>
            <td width='10%'><a href="refer.php"><img alt="" src= "images/refer.png" width="45" height="45"><br /><font color=#00FF00>Refer for<br />Points</a></td>
        </tr>
        </table>
    </div>
    <div id='maincontent'>
