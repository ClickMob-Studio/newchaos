...
<a href='gang.php'>No thanks!</a>
    ...
    if ($_GET['x'] == "delete") {
        ...
        $result = mysql_query("UPDATE `grpgusers` SET `gangleader` = '0' WHERE `id` = '" . $gang_class->leader . "'");
        $result2 = mysql_query("UPDATE `grpgusers` SET `gang` = '0', `grank` = '0' WHERE `gang` = '" . $gang_class->id . "'");
        $result3 = mysql_query("DELETE FROM `gangs` WHERE `id` = '" . $gang_class->id . "'");
        $result4 = mysql_query("DELETE FROM `gangarmory` WHERE `gangid` = '" . $gang_class->id . "'");
        $result5 = mysql_query("DELETE FROM `gangmail` WHERE `gangid` = '" . $gang_class->id . "'");
        $result6 = mysql_query("DELETE FROM `ranks` WHERE `gang` = '" . $gang_class->id . "'");
        $result7 = mysql_query("DELETE FROM `ganginvites` WHERE `gangid` = '" . $gang_class->id . "'");
        $result7 = mysql_query("DELETE FROM `gang_loans` WHERE `gang` = '" . $gang_class->id . "'");
