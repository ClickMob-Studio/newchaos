...
?>		
		...
		<title><?php echo $worked['name'] ?></title>
		...
		* {
		...
		<tr>
			...
			<tr>
				<td><p style='color:white;font-size:16px;font-weight:bold;'><center><?php echo $worked['name'] ?></center></p></td>
			</tr>
			</table>
			...
			<tr>
				<td class='textl' align='center'><img src='<?php echo $worked['image'] ?>' width='100' height='100' style='border: 1px solid #333333'></td>				
			...
			<table width='100%' cellpadding='4' cellspacing='0'>
			<tr>
				<td colspan='3' class='style2'>Details</td>
			</tr>
			<tr>
				<td class='textm'>Name: </td>
				<td class='textr'><?php echo $worked['name'] ?></td>
			...
			<tr>
				<td class='textm'>Airplane Shop Cost: </td>
