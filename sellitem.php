...
if (isset($_POST['submit'])) { //if they confirm they want to sell it
    ...
    $saleQuery = "INSERT INTO `item_sell` (`userid`, `itemid`, `quantity`, `price`, `when`) VALUES ('$user_class->id', '".$_GET['id']."', '".$_POST['amount']."', '" . $price . "', ".time().")";
...
<tr><td class="contentcontent">
        <table width='100%'>
            <tr>
              How many would you like to sell? You currently have <?php echo $howmany;?> x <?php echo $worked['itemname'];?>
              <br>
