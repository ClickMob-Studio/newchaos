...
if ($user_class->current_employer != 0) {
    ...
    if ($_GET['x'] == "disband") {
        ...
        $result1 = mysql_query("DELETE FROM OwnedBusinesses WHERE user_id = '" . $user_class->id . "'");
$result2 = mysql_query("UPDATE grpgusers SET current_employer = 0 WHERE current_employer = '" . $business_class->business_id . "'");
