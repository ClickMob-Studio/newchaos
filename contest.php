...
.prize-container:last-child, .milestone-container:last-child {
    margin-right: 0;
}
...
.flex-container {
    display: flex;
    justify-content: space-between; /* Spacing out children */
    flex-wrap: nowrap; /* Prevent wrapping */
}

/* Specific container adjustments */
.prize-container {
    min-height: 300px; /* Adjust this value as needed to match your content */
}
...
/* Data Table Styling */
.table-container {
    width: calc(50% - 30px); /* Adjust for margins */
...
.bottom-tables {
    display: flex;
    justify-content: space-between; /* Evenly spaces the child tables */
}
...
.reward-box {
    ...
    width: calc(33.333% - 20px); /* Adjust width for three boxes in a row */
    vertical-align: top; /* Align the tops of the boxes if they have unequal heights */
    box-sizing: border-box; /* Include padding and border in the element's width and height */
}

.rewards-container {
    text-align: center; /* Center the text within the container */
    margin-bottom: 20px; /* Spacing below the rewards section */
}
...
echo '<div class="table-container" style="width: 100%;">'; // Set width to 100% to stretch across the right side
