...
if (isset($_POST['unreport'])) {
    $result = mysql_query("UPDATE `freplies` SET `reported` = '0', `reporter` = '0' WHERE `postid` = '" . $_POST['postid'] . "'");
    echo Message("The post was un-reported.");
}
//Delete Thread
if (isset($_POST['deletetopic'])) {
    $result = mysql_query("DELETE FROM `ftopics` WHERE `forumid` = '" . $_POST['postid'] . "'");
    $result = mysql_query("DELETE FROM `freplies` WHERE `topicid` = '" . $_POST['postid'] . "'");
    echo Message("The reported topic was deleted.");
}
//Un-report Thread
if (isset($_POST['unreporttopic'])) {
    $result = mysql_query("UPDATE `ftopics` SET `reported` = '0', `reporter` = '0' WHERE `forumid` = '" . $_POST['postid'] . "'");
