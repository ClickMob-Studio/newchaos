    ...
    <div style="text-align:left;padding:10px;">
        ...
        <p class="text-14">Possible rewards:
            <ul style="list-style:none" class="text-14">
                ...
                <li><b><i><u><font color=red>Points</font></u></i></b></li>
        ...
        <p class="text-14">So the more active you are the more <?php echo item_popup('snowball\'s', 155, '#7eff11') ?> you will earn - make sure to share the love!</p>
        <!-- <h2 class="text-center mb-0">Who will you share your <?php echo item_popup('snowball\'s', 155, '#7eff11') ?> with?</h2> -->
    </div>

    <!-- <h2 class="text-center m-0"  style="color:#7eff11">Can't wait? Need More snowballs?</h2>
