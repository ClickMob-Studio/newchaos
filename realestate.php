...
$worked = mysql_fetch_array($result);
?>
<tr><td class="contentspacer"></td></tr><tr><td class="contenthead">Real Estate Agency</td></tr>
<tr><td class="contentcontent">
Welcome to the Real Estate Agency! If we have any land left available, you can purchase it from here.<br /><br />
<b>Land available in <?php echo $user_class->cityname ?>:</b>&nbsp;<?php echo prettynum($worked['landleft']) ?> acres.<br />
<b>Price per acre:</b>&nbsp;$<?php echo prettynum($worked['landprice']) ?>.
</td></tr>
<tr><td class="contentspacer"></td></tr><tr><td class="contenthead">Buy Land</td></tr>
<tr><td class="contentcontent">
<?php
