...
if ($_SESSION['id'] != 146) {
 ...
 if(!in_array($_SESSION['id'], array(1 ,2 ,6 ,7))){
    include('home.php');
    die();
}
    ...
    echo'<div id="main">';
        echo'<div id="top">';
            echo'<div style="float:left;" id="headerbar">';
				echo'<a href="news.php">News (<!_-news-_!>)</a> | ';
				echo'<a href="gameupdates.php">Updates (<!_-gupdates-_!>)</a> | ';
				echo'<a href="gamerules.php">Game Rules</a> | ';
				echo'<a href="itempedia.php">Itempedia</a> | ';

				echo'<s href="pres.php" style="color:red;font-weight:bold;">Prestige</s> | ';
				echo'<a href="http://facebook.com/YobCity"><font color=#63b3fe>Facebook</font></a> | ';
				echo'<a href="rmstore.php"><font color=red>Sale</font></a> ';
