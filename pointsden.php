...
?>
<tr><td class="contentspacer"></td></tr><tr><td class="contenthead"><h2>Points Den</h2></td></tr>
<tr><td class="contentcontent">
        <?php if ($user_class->id > 0) {
            ?>
...
<tr>
			<td>Energy + 1</td>
				...
				<td><?php echo ($user_class->energyboost) ?>
/250</td>
				<td><?php if ($user_class->energyboost < 250) { echo '<a href="pointsden.php?spend=energy1">[BUY]</a>'; } else { echo 'FULL';}?></td>
...
<tr>
			<td>Nerve + 1</td>
				...
				<td><?php echo ($user_class->nerveboost) ?>
/250</td>
                <td><?php if ($user_class->nerveboost < 250) { echo '<a href="pointsden.php?spend=nerve1">[BUY]</a>'; } else { echo 'FULL';}?></td>
...
<?php
    ...
    if ($user_class->crimeexpboost > 1) {
        $crimeexpbonus += 20;
        $crimeexpbonus += ($user_class->crimeexpboost - 1) * 3.33;
    } else if ($user_class->crimeexpboost == 1) {
        $crimeexpbonus = 20;
    } else {
        $crimeexpbonus = 0;
    }
    $crimeexpbonus = round($crimeexpbonus);
...
<tr>
			<td>Bank Daily Income +10%</td>
                ...
                <td><?php if ($user_class->bankboost < 10) { echo '<a href="pointsden.php?spend=bankinterest">[BUY]</a>'; } else { echo 'FULL';}?></td>
</tr>
...
<?php
        echo '<div id="crimeexp" class="floaty">
            <h2>Points + Nerve Upgrades</h2>
            <p>Total of 100 Upgrades - Maximum Boost of +100 Nerve & Energy</p>
            <p>Level 1-19 Cost: 500 Points Per level or  10,000 Points in total</p>
            <p>Level 20-39 Cost: 1,000 Points Per level or  20,000 Points in total</p>
            <p>Level 40-59 Cost: 2,000 Points Per level or  40,000 Points in total</p>
            <p>Level 60-79 Cost: 4,000 Points Per level or  80,000 Points in total</p>
            <p>Level 80-100 Cost: 8,000 Points Per level or  160,000 Points in total</p>
            <p>Level 101-250 Cost: 10,000 Points Per level or  1,500,000 Points in total</p>





            <p>Cost to Max Level 250 - 1,810,000 Points</p>
        </div>';
        echo '<div id="crimeexp" class="floaty">
        <h2>Bank Income Upgrade</h2>
        <p>Total of 10 Upgrades - Maximum Boost of +100%</p>
        <p>Each upgrade costs 20K Points and grants +10% Bank Daily Income</p>
        <p>Level 10 will take your 600k Daily interest up to 1.2 Million per day!</p>
