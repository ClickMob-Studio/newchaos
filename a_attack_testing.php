...
if (isset($_POST['attack_id']) && $_POST['attack_id']) {
    ...
    echo $attack_person->formattedname . ' S: ' . log($attack_person->moddedstrength,100000) . '<br />';
    echo $attack_person->formattedname . ' D: ' . log($attack_person->moddeddefense,100000) . '<br />';
    echo $user_class->formattedname . ' S: ' . log($user_class->moddedstrength,100000) . '<br />';
    echo $user_class->formattedname . ' D: ' . log($user_class->moddeddefense,100000) . '<br />';
