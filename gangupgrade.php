                                ...
                                <div class="upgrade-package">
                                    ...
                                    <?php elseif ($canUpgrade): ?>
                                        <input class="upgrade-button sufficient-funds" type='submit' name='<?= $key ?>'
                                            value='Upgrade for $<?= number_format($costs[$current_star_level + 1]) ?>'>
                                    <?php else: ?>
                                        <span class="insufficient-funds">Insufficient Cash
                                            ($<?= number_format($costs[$current_star_level + 1]) ?> Required)</span>
                                    <?php endif; ?>
                                    <div class="stars">
                                        <?php
                                        for ($i = 1; $i <= 10; $i++) {
