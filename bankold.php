...
<span style='margin: 0; line-height: 27px; text-transform: uppercase; font-size: 20px; text-align: left; text-indent: 25px;'><h4>YOUR BANKING AREA</h4></span>
  ...
  <div class='container'>
    ...
    <table>
        <tr>
            <th><h4>Bank:</h4></th>
            <td><h4><font color=green>$$user_class->bank</h4></font></td>
            <td></td>
        </tr>
        <tr>
            <th><h4>Daily Interest:</h4></th>
            <td><h4><font color=green>+$$interest</h4></font></td>
            <td></td>
        </tr>
        <tr>
            <th><h4>Interest Rate:</h4></th>
            <td><font color=green><h4>$rate</h4></font></td>
            <td><h4><font color=green>(Max: $15,000,000)</h4></font></td>
        </tr>
    </table>
    <div class='div-form-wrapper'>
        <form method='post' action='?' class='bank-form'>
            <input type='text' name='wamount' value='0' size='10' maxlength='20' />
