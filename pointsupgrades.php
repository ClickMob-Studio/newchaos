...
<div class="upgrade-container">
    ...
    <input class="upgrade-button sufficient-funds" type='submit' name='<?= $key ?>' value='Upgrade for <?= number_format($costs[$current_star_level + 1]) ?> Points'>
<?php else: ?>
    <span class="insufficient-funds">Insufficient Points (<?= number_format($costs[$current_star_level + 1]) ?> Points Required)</span>
<?php endif; ?>
                <div class="stars">
    <?php
    for ($i = 1; $i <= 10; $i++) {
