            ...
            if (!empty($_GET['id'])) {
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($rows as $row) {
                                ?>
                                <tr>
                                    <td><a href='forum.php?topic=<?php echo $row['forumid']; ?>'><?php echo $row['subject']; ?></a></td>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            for ($i = 1; $i <= $j; $i++) {
                                ...
                                ?>
                                <tr>
                                    <td><a href='forum.php?id=<?php echo $i; ?>' class="text-decoration-none"><?php echo $forums[$i]['name']; ?></a><br><span class='text-muted'><?php echo $forums[$i]['sub']; ?></span></td>
                ...
                <div class="mt-4">
                    <span class="fw-bold">
                        ...
                        <a href="forum.php?id=<?php echo $topic['sectionid']; ?>" class="text-decoration-none"><?php echo $names[$topic['sectionid']]; ?></a> &rarr;
                        <?php echo $topic['subject']; ?>
                    </span>
                    <div class="d-flex justify-content-between mt-3 mb-2">
                        <span><?php echo date('d M Y - g:i a', $topic['timesent']); ?></span>
                        <span title="<?php echo implode('&#13;', $ups); ?>" class="badge bg-success forumhover" onclick="rate('up',<?php echo $topic['forumid']; ?>, <?php echo ($topic['rateup'] + 1); ?>);"><img src="images/up.jpg" /> Rate Up (<span id="uprate<?php echo $topic['forumid']; ?>"><?php echo $topic['rateup']; ?></span>)</span>
                        <span title="<?php echo implode('&#13;', $downs); ?>" class="badge bg-danger forumhover" onclick="rate('down',<?php echo $topic['forumid']; ?>, <?php echo ($topic['ratedown'] + 1); ?>);"><img src="images/down.jpg" /> Rate Down (<span id="downrate<?php echo $topic['forumid']; ?>"><?php echo $topic['ratedown']; ?></span>)</span>
                        <span class="badge bg-primary forumhover" onclick="follow();" id="follow"><?php echo $js[2]; ?> Topic</span>
                        <?php if ($edi) { ?>
                        ...
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span title="<?php echo implode('&#13;', $ups); ?>" class="badge bg-success forumhover" onclick="ratepost('up',<?php echo $row['postid']; ?>, <?php echo ($row['rateup'] + 1); ?>);"><img src="images/up.jpg" /> Rate Up (<span id="upratepost<?php echo $row['postid']; ?>"><?php echo $row['rateup']; ?></span>)</span>
                                    <span title="<?php echo implode('&#13;', $downs); ?>" class="badge bg-danger forumhover" onclick="ratepost('down',<?php echo $row['postid']; ?>, <?php echo ($row['ratedown'] + 1); ?>);"><img src="images/down.jpg" /> Rate Down (<span id="downratepost<?php echo $row['postid']; ?>"><?php echo $row['ratedown']; ?></span>)</span>
                                    <?php if ($edi) { ?>
                                        <span class="badge bg-secondary forumhover" onclick="gotoeditreply(<?php echo $row['postid']; ?>);">Edit Post</span>
                                    <?php } ?>
                                </div>
                                <hr>
                                <div class="d-flex">
                                    <div class="me-3">
                                        <div class="text-center">
                                            <img src="<?php echo $poster->avatar; ?>" width="125" height="125" class="img-thumbnail mb-3" />
                                            <p><?php echo $poster->formattedname; ?></p>
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="noedit<?php echo $row['postid']; ?>"><?php echo BBCodeParse($row['body']); ?></div>
                                        <?php echo $edit; ?>
                                    </div>
                                </div>
                            </div>
