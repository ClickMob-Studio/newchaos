...
/100</td>
				<td><?php if ($user_class->energyboost < 100) { echo '<a href="pointsden.php?spend=energy1">[BUY]</a>'; } else { echo 'FULL';}?></td>
...
/100</td>
                <td><?php if ($user_class->nerveboost < 100) { echo '<a href="pointsden.php?spend=nerve1">[BUY]</a>'; } else { echo 'FULL';}?></td>
...
<tr>
			<td>Crime EXP Boost</td>
				<td><?php echo number_format($cost['crimeexpboost'], 0) . ' points'?></td>
				<td><?php echo ($user_class->crimeexpboost) ?> / 10 <?php echo "(" . $crimeexpbonus . "%)"; ?></td>
                <td><?php if ($user_class->crimeexpboost < 10) { echo '<a href="pointsden.php?spend=crimeexp">[BUY]</a>'; } else { echo 'FULL';}?></td>
</tr>
...
<?php
        echo '<div id="crimeexp" class="floaty">
            <h2>Crime EXP Boost Upgrade</h2>
            <p>Total of 10 Upgrades - Maximum Boost of +50%</p>
            <p>Level 1 Cost: 20,000 Points and 20%+ Boost</p>
            <p>Level 2 - 10 Cost: 20,000 Points and 3.33...%+ Boost</p>
        </div>';
        echo '<div id="crimeexp" class="floaty">
