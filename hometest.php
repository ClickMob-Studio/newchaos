...
<!DOCTYPE html>
<html>
<head><script type="1975d1a63e870da9ee08b80a-text/javascript">(window.NREUM||(NREUM={})).init={privacy:{cookies_enabled:true},ajax:{deny_list:["bam.nr-data.net"]},distributed_tracing:{enabled:true}};(window.NREUM||(NREUM={})).loader_config={agentID:"1134329376",accountID:"3179900",trustKey:"3179900",xpid:"VwcAWF9TCBABVFRaBwAAUFMG",licenseKey:"NRJS-800334edfd400ddae1b",applicationID:"1058017677"};;/*! For license information please see nr-loader-spa-1.237.1.min.js.LICENSE.txt */
...
<base href="/">
<title>Prison Struggle | Free Online Browser Based MMORPG Game</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="Free to play browser based MMORPG, think you've got what it takes? Sign up for free today!" />
<meta name="keywords" content="free mmorpg, mmorpg, free mmo,free online mmorpg, free mmo games, mmog, rpg, free online rpg, online rpg, free rpg">
<meta property="og:title" content="Prison Struggle" />
<meta property="og:type" content="website" />
<meta property="og:description" content="Free to play browser based MMORPG, think you've got what it takes? Sign up for free today!" />
<meta property="og:url" content="https://prisonstruggle.com/home.php" />
<meta property="og:image" content="https://prisonstruggle.com/images/social-logo.png" />
...
<meta name="application-name" content="Prison Struggle" />
<meta name="apple-mobile-web-app-title" content="Prison Struggle" />
<meta name="apple-mobile-web-app-status-bar-style" content="black" />
<link rel="manifest" href="/images/manifest.json">
<meta name="msapplication-TileColor" content="#5d2b08">
<meta name="msapplication-TileImage" content="/images/ms-icon-144x144.png">
<meta name="theme-color" content="#5d2b08">
<link rel="dns-prefetch" href="//fonts.googleapis.com">
<link rel="dns-prefetch" href="//kit.fontawesome.com">
<link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin>
<link rel="preconnect" href="https://kit-pro.fontawesome.com/" crossorigin>
<link rel="stylesheet" href="css/newgame/login1.css" />
<link rel="stylesheet" href="https://use.typekit.net/vkl0fgs.css">
<script src="js/login.js" type="1975d1a63e870da9ee08b80a-text/javascript"></script>

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-163972768-2" type="1975d1a63e870da9ee08b80a-text/javascript"></script>
<script type="1975d1a63e870da9ee08b80a-text/javascript">
...
<script type="1975d1a63e870da9ee08b80a-text/javascript">
            !function(w,d){if(!w.rdt){var p=w.rdt=function(){p.sendEvent?p.sendEvent.apply(p,arguments):p.callQueue.push(arguments)};p.callQueue=[];var t=d.createElement("script");t.src="https://www.redditstatic.com/ads/pixel.js",t.async=!0;var s=d.getElementsByTagName("script")[0];s.parentNode.insertBefore(t,s)}}(window,document);rdt('init','t2_h2qfzh2y', {"optOut":false,"useDecimalCurrencyValues":true,"email":"<EMAIL-HERE>","externalId":"<EXTERNAL-ID-HERE>"});rdt('track', 'PageVisit');
        </script>
...
<script type="1975d1a63e870da9ee08b80a-text/javascript">
        ...
        var onloadCallback = function () {
            ...
            [].forEach.call(captchas, function (captcha) {
                var type = captcha.getAttribute('data-type');
                captchaInstances[type] = grecaptcha.render(captcha, {
                    "sitekey": "6LcSGKYZAAAAAGYuMeav2Xggzloe5OnnfImUc17Q",
                    "size": "invisible",
                    "callback": function (token) {
                        if (type === 'desktopLogin') {
                            document.getElementById("desktopLoginForm").submit();
                        }
                        if (type === 'mobileLogin') {
...
<script src="https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit" async defer type="1975d1a63e870da9ee08b80a-text/javascript"></script>
</head>
<body class="warmedals">
<div class="screenshot-popup" onclick="if (!window.__cfRLUnblockHandlers) return false; hideScreenshot()" data-cf-modified-1975d1a63e870da9ee08b80a->
<div class="screenshot-popup-background">
<div class="screenshot-popup-container">
</div>
</div>
</div>
<div class="register-loading loading-overlay">
...
<script type="1975d1a63e870da9ee08b80a-text/javascript">
    function hideScreenshot() {
        document.querySelector('.screenshot-popup').classList.remove('active');
        document.querySelector('.screenshot-popup img').remove();
    }
</script>
<header class="login-header">
<section id="loginFormMobile" class="mobile-login column ">
<form class="column" action="login.php" id="mobileLoginForm" method="post">
...
<div class="toggle">
<input id="mobileRememberMe" name="rememberMe" type="checkbox" />
<span class="fill"></span>
</div>
</div>
</div>
<button type="submit" class="g-recaptcha-disabled" data-type="mobileLogin">
LOGIN
<i class="chevron-right"></i>
</button>
<div class="login-button">
<script type="1975d1a63e870da9ee08b80a-text/javascript">
                    function showMobileForm(loginButton) {
                        loginButton.remove();
                        document.getElementById('loginFormMobile').classList.add('mobile-form-open');
                        setTimeout(() => loginButton.setAttribute('type', 'submit'), 100);
                    }
                    function jump(h){
...
<button class="row" type="button" onclick="if (!window.__cfRLUnblockHandlers) return false; showMobileForm(this)" data-cf-modified-1975d1a63e870da9ee08b80a->
LOGIN
<i class="chevron-right"></i>
<i class="chevron-down"></i>
</button>
<button class="row" type="button" onclick="if (!window.__cfRLUnblockHandlers) return false; return jump('join-form');" data-cf-modified-1975d1a63e870da9ee08b80a->
REGISTER
</button>
</div>
</form>
</section>
<section class="login-bar row">
<div class="login-skin row"></div>
<div class="login-form">
<form class="row" action="login.php" id="desktopLoginForm" method="post">
<span>LOGIN</span>
<div class="input-field">
<div class="remember-me row">
<div class="radio">
<input type="checkbox" name="rememberMe" id="desktopRememberMe" />
<span class="fill"></span>
</div>
<label for="desktopRememberMe">Remember me</label>
</div>
<input id="loginUsername" name="username" type="text" placeholder="Username" tabindex="1" />
</div>
<div class="input-field">
<a href="forgot.php" class="forgot-password">Forgotten password?</a>
<input id="loginPassword" name="password" type="password" placeholder="Password" tabindex="2" />
</div>
<button type="submit" class="g-recaptcha-disabled" data-type="desktopLogin" tabindex="3"></button>
</form>
</div>
</section>
<section class="hero row">
<div class="hero-skin left-skin"></div>
<div class="hero-splash">
<div class="lighting lighting-left"></div>
<div class="lighting lighting-right"></div>
...
<section class="stats-bar row">
<div class="stats-bar-skin row">
<div class="stat-container row">
<div class="stat row">
<span>57</span>
<label>INMATES<br/>ONLINE NOW</label>
</div>
</div>
<div class="stat-container row">
<div class="stat row">
<span>195</span>
<label>INMATES<br/>ONLINE 24H</label>
</div>
</div>
<div class="stat-container row">
<div class="stat row">
<span>6,672</span>
<label>TOTAL<br/>INMATES</label>
</div>
</div>
</div>
</section>
</header>
<main class="row"><section class="join column" id="join-form">
<header class="row">
<div class="join-free-text column">
<span>Not a member?</span>
<span>Join Free</span>
</div>

</header>
<form class="column" id="register-form">
...
<div class="input-field terms row">
<div class="radio">
<input type="checkbox" name="terms" id="desktopTerms" />
<span class="fill"></span>
</div>
<label for="desktopTerms">I accept <a href="/legal.php" target="_blank">terms of use</a></label>
</div>
<div class="input-field subscribe row">
<div class="radio">
<input type="checkbox" name="subscribe" id="optIn" checked />
<span class="fill"></span>
</div>
<label for="optIn">I want to receive marketing messages.</label>
</div>
<div class="g-recaptcha" data-type="register"></div>
...
<header>
<h1><span>welcome to</span><br/>Prison Struggle!!</h1>
</header>
<article>
<p>
<strong>Prison Struggle</strong> is a free to play MMORPG that will take
you through the life of a real prison inmate. You will have
to earn your reputation from the inside while keeping activities
on the outside flowing, a necessity if you are going to be able
to restart your life after your release.
</p>
<p>
Your rise to the top of the inmate civilization will not
be easy, you will face other inmates that will be just as
willing to fight, mug and forge gang alliances as they look
to climb to the top of the social ladder.
</p>
<p>You thought your last spell inside was bad?</p>
<p><strong>Prison has just got a whole lot worse!!!</strong></p>
</article>
</section>
...
<div class="news-item">
<h3><a href="news.php?id=251">DevBlog - July</a></h3>
<p>It&rsquo;s been a busy month here in the confides of the Prison S...</p>
</div>
<div class="news-item">
<h3><a href="news.php?id=250">New Item Upgrades!</a></h3>
<p>Pssst! I just returned from a secret military base working on thi...</p>
</div>
<a class="news-view-all" href="news.php">View all</a>
</div>
</div>
<div class="game-preview-grid row">
<div class="game-preview-splatter row">
<span>Game<br/>Preview</span>

</div>
<div class="screenshot-box">
<figure class="screenshot screenshot-1">

</figure>
</div>
<div class="screenshot-box">
<figure class="screenshot screenshot-2">
...
<script type="1975d1a63e870da9ee08b80a-text/javascript">
        function openScreenshot(element) {
            ...
            img.src = src;
            document.querySelector('.screenshot-popup-container').appendChild(img);
            document.querySelector('.screenshot-popup').classList.add('active');
        }
    </script>
<div class="game-preview-rust"></div>

</section> <div class="main-skin row">
...
&copy; 2020, Prison Struggle. All Rights Reserved.
</section>
<section>
<figure class="column">
...
<script type="1975d1a63e870da9ee08b80a-text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"NRJS-800334edfd400ddae1b","applicationID":"1058017677","transactionName":"ZgYDN0dYW0dRWhZfCl9MNBFcFlxaVFwaGBVZEw==","queueTime":0,"applicationTime":18,"atts":"SkEAQQ9CSEk=","errorBeacon":"bam.nr-data.net","agent":""}</script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="1975d1a63e870da9ee08b80a-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"7f2bfadbee9cdca7","token":"76655a3032ee42fe84ee72afb44b60f0","version":"2023.7.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>