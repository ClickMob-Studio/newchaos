...
if (isset($_POST['buy'])) {
    ...
    if ($type == 1) {
        ...
        Send_Event1($user_class->id, "Has Added <font color=red><b>" . prettynum($qty) . "</b></font> GOLD To The Market for " . prettynum($price) . " Per Credit.", $user_class->id);
        ...
        Send_Event1($user_class->id, "Has Added <font color=red><b>" . prettynum($qty) . "</b></font> GOLD To The Market for " . prettynum($price) . " Per Point.", $user_class->id);
