...
<tr><td class="contentspacer"></td></tr><tr><td class="contenthead">Sell Car</td></tr>

<tr><td class="contentcontent">

        <?php echo "Are you sure that you want to sell your " . $worked['name'] . " for $" . prettynum($price) . "?<br /><br /><a href='sellcar.php?id=" . $_GET['id'] . "&confirm=true'>Yes</a>"; ?>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="garage.php">No</a>
