        ...
        if ($_POST['body'] != "") {
            if (strlen($_POST['subject']) < 41) {
                ...
                $body = addslashes($body);
                 $result = mysql_query("INSERT INTO `tickets` (`ticketid`, `playerid`, `timesent`, `status`, `subject`, `body`)" . "VALUES ('$ticketid', '$playerid', '$timesent', '$status', '$subject', '$body')");
                if ($result) {
...
?>
<tr><td class="contentspacer"></td></tr><tr><div class="contenthead">Help Desk</div></tr>
<tr><td class="contentcontent">
        <table width='100%'>
            <tr>
            <br>
            <tr><div class="contentcontent">
                <center>Welcome to the Help Desk. Here you can report problems such as, Bugs,Hacks,Exploits & General Questions, Please do not Spam this area as you will be banned from using this.
