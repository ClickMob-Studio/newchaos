...
<!--    <input type="hidden" name="business" value="support@generalforces.com">-->
    <input type="hidden" name="business" value="aaron-12-newton12@hotmail.co.uk">
...
<div class="floaty" style="margin: 3px;">
    ...
    <div class="vip-packages" style="display: flex; justify-content: space-around; align-items: stretch; flex-wrap: wrap;">
        ...
        <div class="vip-package">
            ...
            <img src="/css/images/NewGameImages/mugprotection.png" class="your-class-name" style="height: 200px;" alt="Mug Protection">
            <ul>
        ...
        <div class="vip-package">
            ...
            <img src="/css/images/NewGameImages/attackprotection.png" class="your-class-name" style="height: 200px;" alt="Attack Protection">
            <ul>
