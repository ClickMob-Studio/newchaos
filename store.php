...
<div class="floaty" style="margin: 3px;">
    ...
    <div class="quality-of-life-upgrades"
        ...
        <!---->
        <!--                <h4>Purchase now for only<br><a href="store.php?buy=qolsupercrime"><button class="gold-button">50 <img src="https://chaoscity.co.uk/css/images/goldbars.png" alt="Gold bar"></button></a></h4>-->
        <!--            </div>-->
