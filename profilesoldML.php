...
<div class='contenthead floaty'>
        ...
        <div class='profile-package' style='flex: 1; padding: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.5); margin: 5px;'>
            ...
            <h4>" . $profile_class->formattedname . "</h4>
                 ...
                 <p>Player Rating: " . $ratingHTML . "</p>
                         <p>Level: " . $profile_class->level . $prestige . "</p>
    ...
    <table id='newtables' style='width:100%;'>
        <tr>
            <td>Crimes:</td>
            <td>" . prettynum($profile_class->crimesucceeded) . "</td>
        </tr>
        <tr>
            <td>Busts:</td>
        ...
        <tr>
            <td>Kills / Deaths:</td>
            <td>" . prettynum($profile_class->battlewon) . " / " . prettynum($profile_class->battlelost) . "</td>
        </tr>
        <tr>
            <td>Last Active:</td>
            <td><span id='lastActive'>" . ($profile_class->lastactive != 0 ? $profile_class->formattedlastactive : 'Never') . "</span> <span id='onlineStatus'>[online]</span></td>
        </tr>
    </table>
</div>
