...
if ($user_class->firstlogin1 == 0) {
    ...
    Send_Event($user_class->id, "<span style='color:white;'>Welcome To Chaos City!<br>To get you started we are giving you:</span><br><span style='color:white;font-weight:bold;'>&bull;&nbsp;3 VIP Days<br>&bull;&nbsp;$100,000 Cash<br>&bull;&nbsp;1,250 Points</span>", $user_class->id);
}
