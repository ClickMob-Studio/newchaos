...
function item_popup($text, $id, $color = '#ffffffbf')
{
...
{
    $rtn = '';
    $rtn .= '<div class="floaty" style="margin:0;">';
    $rtn .=  $text;
    $rtn .= '</div>';
    return $rtn;
}
...
function formatName($id, $nogang = 0)
{
    ...
    if ($bdays) {
        ...
        $title = "Respected Mobster ({$row['rmdays']} RM Days Left)";
        $whichfont = "#00BF03";
    } else {
        $title = "Not Respected";
        $whichfont = "#009102";
...
function genBars()
{
    global $user_class;
    $rtn = '';
    $rtn .= '<div class="stat_container">';
    $rtn .= '<div class="title"><a href="?spend=refenergy">Energy</a>:</div>';
    $rtn .= '<div class="stat">';
    $rtn .= '<div style="background: url(images/stat_bar_bg.png) no-repeat;width:101px;height:19px;">';
    $rtn .= '<div class="stat_bar" style="background: url(images/orange_bar.png) no-repeat;width:' . $user_class->energypercent . '%;height:19px;float:left;"></div>';
    $rtn .= '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="after_title">' . $user_class->formattedenergy . '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="spacer"></div>';
    $rtn .= '<div class="stat_container">';
    $rtn .= '<div class="title"><a href="?spend=refnerve">Nerve</a>:</div>';
    $rtn .= '<div class="stat">';
    $rtn .= '<div style="background: url(images/stat_bar_bg.png) no-repeat;width:101px;height:19px;">';
    $rtn .= '<div class="stat_bar" style="background: url(images/orange_bar.png) no-repeat;width:' . $user_class->nervepercent . '%;height:19px;float:left;"></div>';
    $rtn .= '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="after_title">' . $user_class->formattednerve . '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="spacer"></div>';
    $rtn .= '<div class="stat_container">';
    $rtn .= '<div class="title"><a href="?spend=refawake">Awake</a>:</div>';
    $rtn .= '<div class="stat">';
    $rtn .= '<div style="background: url(images/stat_bar_bg.png) no-repeat;width:101px;height:19px;">';
    $rtn .= '<div class="stat_bar" style="background: url(images/orange_bar.png) no-repeat;width:' . $user_class->awakepercent . '%;height:19px;float:left;"></div>';
    $rtn .= '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="after_title">' . $user_class->awakepercent . '%</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="spacer"></div>';
    $rtn .= '<div class="stat_container">';
    $rtn .= '<div class="title">Health:</div>';
    $rtn .= '<div class="stat">';
    $rtn .= '<div style="background: url(images/stat_bar_bg.png) no-repeat;width:101px;height:19px;">';
    $rtn .= '<div class="stat_bar" style="background: url(images/red_bar.png) no-repeat;width:' . $user_class->hppercent . '%;height:19px;float:left;"></div>';
    $rtn .= '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="after_title">' . $user_class->hppercent . '%</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="spacer"></div>';
    $rtn .= '<div class="stat_container">';
    $rtn .= '<div class="title">EXP:</div>';
    $rtn .= '<div class="stat">';
    $rtn .= '<div style="background: url(images/stat_bar_bg.png) no-repeat;width:101px;height:19px;">';
    $rtn .= '<div class="stat_bar" style="background: url(images/green_bar.png) no-repeat;width:' . $user_class->exppercent . '%;height:19px;float:left;"></div>';
    $rtn .= '</div>';
    $rtn .= '</div>';
    $rtn .= '<div class="after_title">' . $user_class->exppercent . '%</div>';
    $rtn .= '</div>';
    return $rtn;
}
