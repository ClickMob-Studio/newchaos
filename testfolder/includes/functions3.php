...
function genBars() {
	global $user_class;
	$rtn = '<div class="flexcont" style="border: 0px thin solid #666666;">';
		$rtn .= '<div class="flexele" style="flex:16;">';
			$rtn .= '<b>Health:</b> ' . $user_class->hppercent . '%<br />';
			$rtn .= '<div class="progress-bar blue stripes">';
				$rtn .= '<span style="width: ' . $user_class->hppercent . '%;"></span>';
			$rtn .= '</div>';
		$rtn .= '</div>';
		$rtn .= '<div class="flexele" style="flex:16;">';
			$rtn .= '<a style="color:yellow;font-weight:bold;font-size:1em;" href="?spend=refenergy">Energy:</a> ' . prettynum($user_class->formattedenergy) . '<br />';
			$rtn .= '<div class="progress-bar blue stripes">';
				$rtn .= '<span style="width: ' . $user_class->energypercent . '%;"></span>';
			$rtn .= '</div>';
		$rtn .= '</div>';
		$rtn .= '<div class="flexele" style="flex:36;">';
			$rtn .= '<b>EXP:</b> ' . $user_class->exppercent . '% [' . prettynum($user_class->maxexp - $user_class->exp) . ' to go]<br />';
			$rtn .= '<div class="progress-bar blue stripes">';
				$rtn .= '<span style="width: ' . $user_class->exppercent . '%;"></span>';
			$rtn .= '</div>';
		$rtn .= '</div>';
		$rtn .= '<div class="flexele" style="flex:16;">';
			$rtn .= '<a style="color:yellow;font-weight:bold;font-size:1em;" href="?spend=refawake">Awake:</a> ' . $user_class->awakepercent . '%<br />';
			$rtn .= '<div class="progress-bar blue stripes">';
				$rtn .= '<span style="width: ' . $user_class->awakepercent . '%;"></span>';
			$rtn .= '</div>';
		$rtn .= '</div>';
		$rtn .= '<div class="flexele" style="flex:16;">';
			$rtn .= '<a style="color:yellow;font-weight:bold;font-size:1em;" href="?spend=refnerve">Nerve:</a> ' . prettynum($user_class->formattednerve) . '<br />';
			$rtn .= '<div class="progress-bar blue stripes">';
				$rtn .= '<span style="width: ' . $user_class->nervepercent . '%;"></span>';
			$rtn .= '</div>';
		$rtn .= '</div>';
	$rtn .= '</div>';
	return $rtn;
