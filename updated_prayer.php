            ...
            <table width='100%'>
                ...
                <tr>
                    <td class='contentcontent' width='33%' align='center'><input type='radio' name='prayer'
                            value='1'><b>EXP</b></td>
                    <td class='contentcontent' align='center'><input type='radio' name='prayer' value='2'><b>Money</b>
                    </td>
                    <td class='contentcontent' width='33%' align='center'><input type='radio' name='prayer'
                            value='3' /><b>Points</b></td>
                </tr>
                <tr>
                    <td class='contentcontent' align='center'>O Lord, in this time of need, strengthen me. You are my
                        strength and my shield; You are my refuge and strength, a very present help in trouble. I know,
                        Father, that Your eyes go to and fro throughout the earth to strengthen those whose hearts long
                        for You. The body grows weary, but my hope is in You to renew my strength.</td>
                    <td class='contentcontent' align='center'>Angels of the living God, search the land of the living
                        and the dead and recover all my stolen wealth in Jesus' name. Let the resurrection power of the
                        Lord Jesus Christ come upon the works of my hands in Jesus' name, let my angel of blessing
                        locate me today in the name of Jesus.</td>
                    <td class='contentcontent' align='center'>Give me a penetrating mind to discover, firm to judge,
                        open to understand, free to serve the truth; an honest mind in telling what it sees rather than
                        what it wants to see; a tolerant mind which does not dictate to other people, but which explain
                        what it sees clearly; a mind infused by the light and the truth of your Son Jesus, patient in
                        faith, while waiting for the vision of eternal life.</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <img src="/mnt/data/test_image.png" width="100" height="100" alt="test" title="test"
                            style="margin:5px;" /><img src="/mnt/data/test_image.png" width="100" height="100"
                            alt="test" title="test" style="margin:5px;" /><img src="/mnt/data/test_image.png"
                            width="100" height="100" alt="test" title="test" style="margin:5px;" /><img
                            src="/mnt/data/test_image.png" width="100" height="100" alt="test" title="test"
                            style="margin:5px;" /><img src="/mnt/data/test_image.png" width="100" height="100"
                            alt="test" title="test" style="margin:5px;" />
                    </td>
                </tr>
            </table>
        </form>
