...
if ($firstn > "0") {
    if ($grada != $user_class->gradtwo) {
        $result = mysql_query("UPDATE `opexusers` SET `gradone`='" . $grada . "' WHERE `id`='" . $user_class->id . "'");
...
if ($secondn > "0") {
    if ($gradb != $user_class->gradone) {
        $result = mysql_query("UPDATE `opexusers` SET `gradtwo`='" . $gradb . "' WHERE `id`='" . $user_class->id . "'");
        echo Message('<center>Your gradient name has been updated. You will see the effect when you visit another page.</center>');
    } else {
...
?>
<tr><td class="contenthead">Gradient Color Change</td></tr>
...
<table align='center'>
    <tr>
        <td><b><font color="#000000">Black</font></b></td><td> - </td>
        <td><a href='colorname.php?firstn=9'>First</a> / <a href='colorname.php?secondn=9'>Second</a></td>
    </tr>
    <tr>
        <td> <b><font color="#FFFFFF">White</font></b></td><td> - </td>
