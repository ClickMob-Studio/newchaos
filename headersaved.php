        ...
        <div class="top_level row">
				...
				<div class="center_side">
					<div id="links">
						...
						<a href="/store.php"><strong>Vip Store</strong></a>
					</div>
					<div id="logo">
				...
				<div class="right_side">
					<div class="info_slot">
                        <a href="bank.php?h_deposit=cash" style="text-decoration: none; color:#FFF">
...
?></span>
			...
			<div class="red_bar row">
				<div id="stat_section">
					<div class="stats">
						<a href="?spend=refenergy" style="text-decoration: none; color:#FFF">ENERGY</a><div class="r-text"><?php echo $user_class->energy;?> / <?php echo $user_class->maxenergy;?></div>
						<div class="spacer"></div>
					...
					<div class="stats">
                        <a href="?spend=refnerve" style="text-decoration: none; color:#FFF";>NERVE</a><div class="r-text"><?php echo $user_class->nerve;?> / <?php echo $user_class->maxnerve;?></div>
						<div class="spacer"></div>
						<div style="background: url(../assets/images/stat-bar-bg.png) top center no-repeat;width: 147px;height: 22px;">
							<div class="stat-bar">
