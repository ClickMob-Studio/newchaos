        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <center>
                    <br />
                    <p>
                        Welcome to Santa's Grotto. Being in the Mafia isn't just about killing, committing crimes and
                        earning the big bucks. We've got to let
                        our community know that we support them to bring the future mafia bosses into the world. Santa's
                        Grotto is a place where you can donate
                        Christmas Gifts to the community and in return you'll be given a random gift back. The more you
                        donate, the more you'll receive in return.
                    </p>
                    <hr />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="progress" role="progressbar"
                                aria-valuenow="<?php echo ($userSantasGrotto['exp'] / 100 * 100); ?>" aria-valuemin="0"
                                aria-valuemax="100" title="<?php echo $userSantasGrotto['exp'] . '/100'; ?>">
                                <div class="progress-bar bg-success ba-level-progress-bar"
                                    style="width: <?php echo ($userSantasGrotto['exp'] / 100 * 100); ?>%"></div>
                            </div>

                            <br />
                            <p style="color: red;"><strong>You currently have <?php echo $christmasGiftCount ?>
                                    Christmas Gifts</strong></p>
