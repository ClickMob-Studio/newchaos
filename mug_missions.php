...
include "header.php";
?>
<div class='box_top'>Mug Missions</div>
<div class='box_middle'>
    <div class='pad'>
        ...
        if (isset($_GET['reset_mission']) && (int) $_GET['reset_mission']) {
            ...
            $r = $db->fetch_row(true);
            if (!$r) {
                diefun('You do not have an active mission to reset.');
            }
            ...
            diefun('You have successfully reset your mission. <a href="mug_missions.php">Go Back</a>');
        }
        ...
        $missions = get_missions_by_category(5);
