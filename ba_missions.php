...
if (isset($_GET['reset_mission']) && (int)$_GET['reset_mission']) {
    ...
    mysql_query("UPDATE missions SET completed = 'no', timestamp = " . $now . ", crimes = 0, mugs = 0, kills = 0, busts = 0, backalleys = 0, crimes_paid = 0, kills_paid = 0, busts_paid = 0, mugs_paid = 0 WHERE id = " . $r['id']);
