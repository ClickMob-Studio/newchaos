...
if (isset($_GET['buy'])) {
    ...
    if ($_GET['buy'] == "limitedpack") {
        if ($user_class->limiteditems1 == 0) {
        ...
        } else if ($user_class->credits >= 500) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems1` = limiteditems1 - 1 WHERE `limiteditems1` != '0'");
                         $db->query("UPDATE grpgusers SET  credits = credits - 500, raidtokens = raidtokens + 15, points = points + 500000 WHERE id = ?");

                $db->execute(array(
                               $user_class->id
            ));
            Give_Item(68, $user_class->id, 1);
            Give_Item(69, $user_class->id, 1);
            Give_Item(196, $user_class->id, 1);
            ...
            $db->execute(array());
            echo Message("You spent 500 credits on your Standard Package!");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack2") {
        if ($user_class->limiteditems2 == 0) {
            echo Message("This Pack Is No Longer Available.");
        } else if ($user_class->credits >= 5000) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems2` = limiteditems2 - 1 WHERE `limiteditems2` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 6000000,  raidtokens = raidtokens + 50,bank = bank + 0, credits = credits - 5000 WHERE id = ?");

                $db->execute(array(
                               $user_class->id
            ));
             Give_Item(68, $user_class->id, 5);
            Give_Item(69, $user_class->id, 5);
            Give_Item(194, $user_class->id, 5);
            ...
            Send_Event($user_class->id, "You have been credited your Intermidiate Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 5000 credits on your Intermediate Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack3") {
        if ($user_class->limiteditems3 == 0) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems3` = limiteditems3 - 1 WHERE `limiteditems3` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 35000000, raidtokens = raidtokens + 150, credits = credits - 25000 WHERE id = ?");
            ...
            Give_Item(194, $user_class->id, 50);
            Give_Item(192, $user_class->id, 5);
            Give_Item(193, $user_class->id, 5);
            ...
            $db->execute(array());
            echo Message("You spent 25000 credits on your Extreme Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "freebie") {
        if ($user_class->claimed == 1) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `claimed` = 1 WHERE id = ?");
                         $db->query("UPDATE grpgusers SET  points = points + 2500, raidtokens = raidtokens + 1, claimed = 1, credits = credits - 0 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Free Package 2,500 Points and 1 Raid Tokens! <a href='raid.php'>Click Here To start a raid!</a>.</br>Come back next hour to claim again!", $user_class->id);
            $db->execute(array());
            echo Message("Happy Levelling!. You have been credited 2,500 Points & a Raid Token!</br>Come back next hour to claim again! ");
        } else {
...
<br><br>
<div class="pulsate" style="font-family:Creepster;font-size: 3.5em;color:gold;text-align: center;margin-bottom: 20px;margin-top: -20px;">Super Limited Packages</div>
<br>
<div class="pulsate" style="font-family:timesnewroman;font-size: 2.0em;color:gold;text-align: center;margin-bottom: 20px;margin-top: -20px;">Once these Limited packs run out they will no longer be obtainable</div>
<?php
echo '<div id="pricing-table" class="clear">';
    echo '<div class="plan">';
             echo '<h5><font color=gold>The Standard Package</font></h5>'; //<span><s>300</s></br>Credits</span>
        echo '<ul>';
         ...
         echo '<li><font color=red> Raid Token</font><font color=white>[x15]</font></li>';
        ...
        echo '</ul>';
            echo '<li> <b><span style="color:#FFFFFF">' . $user_class->limiteditems1 . ' / 5 Remaining</span></b></li>';
            echo '<div class="price"> <img src="css/images/coin.png"><span><font color=yellow>500</font></span></div>';

        echo '<a class="signup" href="?buy=limitedpack">Buy Now</a>';     echo '</div>';
 echo '<div class="plan">'; //id="most-popular"
         echo '<h5><font color=gold>The Intermediate Package</font></h5>';//<span></br>Credits</span>
        echo '<ul>';
           echo '<li><b><span style="color:#FFFFFF">6,000,000 Points</span></b></li>';
      ...
      echo '<li><span style="color:#FFF000"> ' .  item_popup('Nerve Booster+25', 68, 'blue') . ' <font color=white>[x5]</font></span></b></li>';
        ...
        echo '</ul>';
            echo '<li><b><span style="color:#FFFFFF">' . $user_class->limiteditems2 . ' / 5 Remaining</span></b></li>';
            echo '<div class="price"> <img src="css/images/coin.png"><span><font color=yellow>5,000</font></span></div>';
        echo '<a class="signup" href="?buy=limitedpack2">Buy Now</a>';     echo '</div>';
echo '<div class="plan">';
        echo '<h5><font color=gold>The Ultimate Package</font></h5>'; //<span>750</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#FFFFFF">35,000,000 Points</span></b></li>';
         ...
         echo '<li><font color=red> Raid Token</font><font color=white>[x150]</font></li>';
               ...
               echo '</ul>';
            echo '<li><b><span style="color:#FFFFF">' . $user_class->limiteditems3 . ' / 3 Remaining</span></b></li>';
            echo '<div class="price"> <img src="css/images/coin.png"><span><font color=yellow>25,000</font></span></div>';
...
<div class="section-row">
    ...
    <div class="section" style="flex-basis: 60%">
        ...
        <div class="section-items">
            ...
            <div class="new-shop-item" data-tooltip="1x Nerve Boosters + 1x Energy Boosters">
                <div class="new-shop-item--img">
