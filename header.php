        ...
        $("#countdown").html("");
            ...
            <span id="countdown">Ends In ' . countdown(1662965999) . '</span></div>';
                        ...
                        if ($tempItemUse['crime_15_multiplier_time'] > $time) {
                            $messages[] = '<li class="event-countdown" data-end="' . $tempItemUse['crime_15_multiplier_time'] . '">[ 50x Crimes: <span class="countdown-text">' . secondsToTime($tempItemUse['crime_15_multiplier_time'] - $time) . '</span> ]</li>';
                        }
