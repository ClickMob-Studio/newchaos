...
<head>
    ...
    <script id="cytoscape-popper-js"
        src="https://cdn.jsdelivr.net/npm/cytoscape-popper@1.0.7/cytoscape-popper.js"></script>
                    ...
                    <div class="p-3 dcPanel dcAvatarPanel d-none d-md-block">
                        <div class="row mb-3">
                            ...
                            <div style="margin-top: 4px;">
                                Level <span class="level"><?= number_format($user_class->level); ?></span>
                            </div>
                                ...
                                <div class="row my-0 my-lg-1">
                                    <div class="col-3 d-flex align-items-center">
                                        <div class="d-flex">Level <div class="level" style="margin-left: 4px;">
                                                <?= number_format($user_class->level); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-9 d-flex align-items-center align-items-center2 d-lg-none"
