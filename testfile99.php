...
if ($user_class->gang != 0) {
    ...
    $upgrade_details = array(
        'upgrade1' => array('name' => 'Strength Upgrade', 'benefit' => 'Each upgrade will grant your members an additional 20% bonus to their strength during a battle!'),
        'upgrade2' => array('name' => 'Defence Upgrade', 'benefit' => ''),
        'upgrade3' => array('name' => 'Speed Upgrade', 'benefit' => ''),
        'upgrade4' => array('name' => 'Upgrade 4', 'benefit' => ''),
        'upgrade5' => array('name' => 'Upgrade 5', 'benefit' => ''),
        'upgrade6' => array('name' => 'Upgrade 6', 'benefit' => ''),
        'upgrade7' => array('name' => 'Upgrade 6', 'benefit' => ''),
        'upgrade8' => array('name' => 'Upgrade 6', 'benefit' => ''),
        'upgrade9' => array('name' => 'Upgrade 6', 'benefit' => ''),
        'upgrade10' => array('name' => 'Upgrade 6', 'benefit' => ''),
    );
    ...
    $upgrade_keys = ['upgrade1', 'upgrade2', 'upgrade3', 'upgrade4', 'upgrade5', 'upgrade6', 'upgrade7', 'upgrade9','upgrade9','upgrade10'];
