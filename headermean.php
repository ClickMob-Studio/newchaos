...
echo'<div class="dateregen">';
            ...
            echo'<div class="profile">';
                ...
                echo'<div class="profavtar"></div><!--profavtar-->';
              echo'<div class="profinfo">';
                        echo'<div class="profid">';
                            echo'<p>IMAGE HERE(M/F)&nbsp;</p>';
                        echo'</div><!--profid-->';
                        ...
                        echo'<div class="proflevel">';
                            echo'<p>ID: <td><span class="id">?<!_-id-_!></span></td> | Level: <td><span class="level"><!_-level-_!></span></td></p>';
                        echo'</div><!--proflevel-->';
              ...
              echo'<div class="pointslab">';
                echo'<div class="pointsec">';
                    ...
                    echo'<div class="point">';
                        echo'<p><span id="points_container"><!_-points-_!></span></p>';
                   ...
                   echo'</div><!--point-->';
                    ...
                    echo'<div class="credit">';
                        echo'<p><span id="credits_container"><!_-credits-_!></span></p>';
                    echo'</div><!--credit-->';
                echo'</div><!--creditsec-->';
echo'<div class="logo">';
                ...
                echo'</div><!--logo-->';
                   ...
                   echo'</div><!--moneyinhand-->';
                    echo'<a href = "bank.php?dep=all"></a>';
