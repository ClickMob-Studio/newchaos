...
$tag->WriteThirdSegment($tag->ArialBold, "HP: ", $tag->white, $tag->ArialBold, $HP, ((intval($HP) < 75) ? $tag->red : $tag->green));
...
if (isset($_GET['id'])) {
    ...
    // [Gang tag] Gang Name 
    $tag->WriteFirstSegment($tag->ArialBold, "[" . $gang->Tag . "]", $tag->white, $tag->ArialBold, $gang->Name, $tag->white);
    ...
    $tag->WriteThirdSegment($tag->ArialBold, $Members, $tag->white, $tag->ArialBold, "", $tag->white);
