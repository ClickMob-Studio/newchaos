    ...
    if (!empty($_POST['topic']))
        if (!empty($_POST['body']))
            if (strlen($_POST['topic']) < 41) {
                ...
                // mysql_query("INSERT INTO gftopics (sectionid, playerid, lastreply, timesent, subject, body) VALUES ($user_class->gang, $user_class->id, unix_timestamp(), unix_timestamp(), '$subject', '$body')");
