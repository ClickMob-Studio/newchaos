...
echo '<div id="pricing-table" class="clear">';
  ...
  echo '<li><b><span style="color:#000000"><img src="https://themafialife.com/css/images/NewGameImages/fireworks.png" width="100px"></br> <b><span style="color:#000000"> ' .  item_popup('Fireworks', 158, 'yellow') . ' [x1]</span></b></span></b></li>';
 ...
 echo '<div class="plan">'; //id="most-popular"
  ...
  echo '<li><b><span style="color:#000000"><img src="https://themafialife.com/css/images/NewGameImages/fireworks.png" width="100px"></br> <b><span style="color:#000000"> ' .  item_popup('Fireworks', 158, 'yellow') . ' [x10]</span></b></span></b></li>';
...
echo '<div class="plan">';
        ...
        echo '<ul>';
            echo '<li><b><span style="color:#000000">3,750,000 Points</span></b></li>';
  echo '<li><b><span style="color:#000000"><img src="https://themafialife.com/css/images/NewGameImages/fireworks.png" width="100px"></br> <b><span style="color:#000000"> ' .  item_popup('Fireworks', 158, 'yellow') . ' [x50]</span></b></span></b></li>';
     echo '<li><b><span style="color:#000000"> ' .  item_popup('Attack Protection', 9, 'green') . ' [x10]</br> ' .  item_popup('Mug Protection', 8, 'green') . ' [x10] </span></b></li>';
