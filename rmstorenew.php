...
if (isset($_GET['buy'])) {
    ...
    if ($_GET['buy'] == "limitedpack") {
        if ($user_class->limiteditems1 == 0) {
            ...
            Send_Event($user_class->id, "You have been credited your Standard Fireworks  Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 200 credits on your Standard Fireworks Package!");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack2") {
        if ($user_class->limiteditems2 == 0) {
            ...
            Give_Item(10, $user_class->id, 5);
                                             ...
                                             Give_Item(158, $user_class->id, 10);
            ...
            Send_Event($user_class->id, "You have been credited your Large Fireworks Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 2000 credits on your Large Fireworks  Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack3") {
        if ($user_class->limiteditems3 == 0) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems3` = limiteditems3 - 1 WHERE `limiteditems3` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 3750000, credits = credits - 10000 WHERE id = ?");
                ...
                $db->execute(array(
                               $user_class->id
                                             ...
                                             Give_Item(9, $user_class->id, 25);
                                             Give_Item(158, $user_class->id, 50);
            ...
            Send_Event($user_class->id, "You have been credited your Extreme Fireworks Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 10,000 credits on your Extreme Gamer Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
echo '<div id="pricing-table" class="clear">';
    echo '<div class="plan">';
             echo '<h5><font color=green>Standard Fireworks Package</font></h5>'; //<span>200</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#FFF000">30,000 Points</span></b></li>';

  echo '<li><b><span style="color:#FFF000"><img src="https://themafialife.com/css/images/NewGameImages/fireworks.png" width="100px"></br> <b><span style="color:#FFF000"> ' .  item_popup('Fireworks', 158, 'yellow') . ' [x1]</span></b></span></b></li>';
 ...
 echo '<div class="plan">'; //id="most-popular"
         echo '<h5><font color=green>Large Fireworks Package</font></h5>';//<span>500</br>Credits</span>
        echo '<ul>';
           echo '<li><b><span style="color:#FFF000">500,000 Points</span></b></li>';

  echo '<li><b><span style="color:#FFF000"><img src="https://themafialife.com/css/images/NewGameImages/fireworks.png" width="100px"></br> <b><span style="color:#FFF000"> ' .  item_popup('Fireworks', 158, 'yellow') . ' [x10]</span></b></span></b></li>';
...
echo '<div class="plan">';
        echo '<h5><font color=green>Mega Fireworks Package</font></h5>'; //<span>750</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#FFF000">3,750,000 Points</span></b></li>';
  echo '<li><b><span style="color:#FFF000"><img src="https://themafialife.com/css/images/NewGameImages/fireworks.png" width="100px"></br> <b><span style="color:#FFF000"> ' .  item_popup('Fireworks', 158, 'yellow') . ' [x50]</span></b></span></b></li>';
     echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Attack Protection', 9, 'green') . ' [x10]</br> ' .  item_popup('Mug Protection', 8, 'green') . ' [x10] </span></b></li>';
