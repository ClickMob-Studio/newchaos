...
<tr><td class="contentspacer"></td></tr><tr><td class="contenthead">Slot Machine</td></tr>
...
<tr><td class="contentcontent">
<form method='post'>
To play, enter the amount of turns you wish to use, and the money you wish to bet per turn, then press spin.<br><br>
		You have <?php echo $user_class->slots; ?> slot machine turns left.<br><br>
		Use 
<input type='text' name='turns' value=''> Turns<br><br>

		$<input type='text' name='money' value='<?php echo $slotmoney; ?>'> [max: $<?php echo $slotmoney; ?>]<br><br>
