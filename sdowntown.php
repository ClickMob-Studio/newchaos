...
if ($_GET['buy'] == "buysearchesyes") {
    if ($user_class->turns > 9) {
        ...
        $result = mysql_query("UPDATE `grpgusers` SET `searchdowntown` = searchdowntown+100 WHERE `id`='" . $_SESSION['id'] . "'");
...
?>
<tr><td class="contentspacer"></td></tr><tr><div class="contenthead">Search Downtown</div></tr>
