			...
			<form method='post'>
				<input type='hidden' name='actsearch' value='1' />
					<table id='newtables' style='margin:auto;'>
						<tr>
							<th>ID:</th>
							<td><input type='text' name='id' value='{$search['id']}'></td>
						</tr>
						<tr>
    <th>Name:</th>
    <td><input type='text' id='nameSearch' name='Name' value='{$search['name']}'></td>
</tr>						<tr>
							<th>Level:</th>
							<td>
...
if (isset($_POST['id'])) {
    ...
    echo '
		<table id="newtables" style="width:100%;">
			...
			$query = mysql_query("SELECT * FROM `grpgusers` WHERE {$sql} ORDER BY rand() DESC LIMIT 25");
