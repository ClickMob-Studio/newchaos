...
while ($line = mysql_fetch_array($result)) {
    $result = mysql_query("UPDATE `grpgusers` SET `todayskills` = '0', `todaysexp` = '0', `boxes_opened` = '1', `crimeauto` = '0', `asmuggling` = '6', `prayer` = '1', `searchdowntown` = '100', `spins` = '20', `todayskills` = '0', `todaysexp` = '0',  `gameevents` = '0', `voted1`='0', `doors`='3', `slots_left1`='100', `roulette`='1', `luckydip`='1', `csmuggling` = '6', `chase` = '1' WHERE `id`='" . $line['id'] . "'");
}
?>