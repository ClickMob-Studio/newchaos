...
?>
<tr><td class="contentspacer"></td></tr><tr><td class="contenthead">Bust Contest</td></tr>
<tr><td class="contentcontent">

<tr><td><center><font color=red><b>Welcome to The Bust contest</b></font></center><br>This is your chance to win some amazing prizes! All you need to do is win more attacks than
...
Along with the top 3 busters recieving these prizes. All users will also receive a prize if they hit these Bust Thresholds </br>
</br>
...
<?php
$result = mysql_query("SELECT * FROM `grpgusers` ORDER BY `bustcomp` DESC LIMIT 25");
$rank = 0;
