...
if (isset($_GET['buy'])) {
    ...
    if ($_GET['buy'] == "7daygrady")
        diefun("Are you sure you want to buy a 7 Day Colour Gradient Name? <br><a href='VIPstore.php?buy=7daygradyes'>Continue</a><br /><a href='VIPstore.php'>No thanks!</a>");
    if ($_GET['buy'] == "imgname")
...
echo '<center>';
?>
<span id="creditDisplay"><font color='white'>For a donation of $0, you will receive <font color=yellow><b></b>0</font> <img src="https://mafialords.com/mafialordsicons/goldbar.png"></img></font></span>
...
<div class="floaty" style="margin:3px;">
    ...
    <div class="vip-packages" style="display: flex; justify-content: space-around; align-items: stretch; flex-wrap: wrap;">
        ...
        <div class="vip-package">
            ...
            <h4>Purchase now for only<br><a href="VIPstore.php?buy=limitedpack"><button class="gold-button"><img src="https://mafialords.com/mafialordsicons/goldbar.png"></img>100</button></a></h4>
        </div>
        ...
        <div class="vip-package">
            ...
            <h4>Purchase now for only<br><a href="VIPstore.php?buy=limitedpack2"><button class="gold-button"><img src="https://mafialords.com/mafialordsicons/goldbar.png"></img>1,000</button></a></h4>
        </div>
        ...
        <div class="vip-package">
            ...
            <h4>Purchase now for only<br><a href="VIPstore.php?buy=limitedpack3"><button class="gold-button"><img src="https://mafialords.com/mafialordsicons/goldbar.png"></img>10,000</button></a></h4>
        </div>
    </div>
</div>
<br>
...
.gradient-text {
    ...
    color: transparent;
    display: inline-block; /* Needed to apply the gradient on text */
    text-shadow: 0 0 8px red; /* Red glow around the text */
...
.buy-now-button:hover {
    background-color: #0e0e0e; /* Slightly darker on hover */
}
...
.vip-package ul {
    padding-left: 20px; /* Indent for the benefit list */
}

.vip-package p {
    font-size: 18px; /* Larger font size for cost */
...
.gold-button {
    ...
    font-size: 16px;
    box-shadow: 0 0 transparent; /* Set box-shadow to transparent by default */
}

.gold-button:hover {
    background-color: #111111;
    color: #111111;
    box-shadow: 0 0 10px 2px gold; /* Adjusted box-shadow size with glow effect */
}
