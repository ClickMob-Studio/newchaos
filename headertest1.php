...
// Home/Inventory
echo '<li class="submenu-toggle"><span class="menu-text">Index</span>';
echo '<ul class="submenu">';
echo '<p><a href="index.php"><span class="menu-text">Home</span></a></p>';
echo '<p><a href="inventory.php"><span class="menu-text">Inventory</span></a></p>';
echo '<p><a href="city.php"><span class="menu-text"><!_-cityname-_!></span></a></p>';
echo '</ul>';
echo '</li>';
echo '<li class="submenu-toggle"><span class="menu-text">Active Comps</span>';
echo '<ul class="submenu">';
echo '<li><a href="raidcomp.php"><span class="menu-text">Raid Contest</span></a></li>';
echo '<li><a href="bloodbath.php"><span class="menu-text">Bloodbath</span></a></li>';
echo '</ul>';
echo '</li>';
// Raids(Collapsible)
echo '<li class="submenu-toggle"><span class="menu-text">Raids Section</span>';
echo '<ul class="submenu">';
echo '<li><a href="raids.php"><span class="menu-text">Raids</span></a></li>';
echo '<li><a href="raid_stats_page.php"><span class="menu-text">Raid Character</span></a></li>';

echo '</ul>';
echo '</li>';
echo '<li class="submenu-toggle"><span class="menu-text">Communication</span>';
echo '<ul class="submenu">';
...
echo '</ul>';
echo '</li>';
// Mail and Events with dynamic notifications
$classForGameUpdates = $user_class->diamonds > 0 ? 'glow-pulse' : '';

// Gang Section (Collapsible)
if($user_class->gang == 0) {
    echo '<li><a href="creategang.php"><span class="menu-text">Create Gang</span></a></li>';
} else {
    echo '<li class="submenu-toggle"><span class="menu-text">Gang</span>';
    echo '<ul class="submenu">';
    echo '<li><a href="gang.php"><span class="menu-text">Your Gang</span></a></li>';
    echo '<li><a href="gangmail.php"><span class="menu-text">Gang Mail</span></a></li>';
...
echo '<li class="submenu-toggle"><span class="menu-text">Financial</span>';
echo '<ul class="submenu">';
echo '<li><a href="bank.php"><span class="menu-text">Bank</span></a></li>';
echo '<li><a href="jail.php"><span class="menu-text">Jail</span></a></li>';
echo '</ul>';
echo '</li>';

// Crimes (Collapsible)
echo '<li class="submenu-toggle"><span class="menu-text">Crimes</span>';
echo '<ul class="submenu">';
echo '<li><a href="crime.php"><span class="menu-text">Crimes</span></a></li>';
echo '<li><a href="newcrimes.php"><span class="menu-text">Crimes (SPEED)</span></a></li>';
echo '</ul>';
echo '</li>';

// Personal (Collapsible)
echo '<li class="submenu-toggle"><span class="menu-text">Personal</span>';
echo '<ul class="submenu">';
...
echo '<li class="submenu-toggle"><span class="menu-text">Community</span>';
echo '<ul class="submenu">';
...
if ($user_class->claimed == 0 && basename($_SERVER['PHP_SELF']) != 'VIPstore.php') {    // The original echo statement for the claim message should be commented out or removed
    ...
    <ul class="gift-list">
        <h4>10,000</strong> Points to help you level!</h4>
        <h4>+ 15 Raid Tokens</h4>
