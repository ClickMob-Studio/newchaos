...
if ($user_class->gang != 0) {
    ...
    if (isset($_POST['deposit'])) {
        ...
        elseif ($amount < 1)
            ...
            perform_query("UPDATE gangs SET moneyvault = ? WHERE id = ?", [$gang_class->moneyvault, $gang_class->id]);
            perform_query("INSERT INTO gang_vault_log (gang_id, user_id, type, added, balance) VALUES (?, ?, 'money', ?, ?)", [$gang_class->id, $user_class->id, $amount, $gang_class->moneyvault]);
    ...
    if (isset($_POST['deposit2'])) {
        ...
        elseif ($amount < 1)
            ...
            perform_query("UPDATE grpgusers SET points = ? WHERE id = ?", [$user_class->points, $user_class->id]);
            perform_query("UPDATE gangs SET pointsvault = ? WHERE id = ?", [$gang_class->pointsvault, $gang_class->id]);
            perform_query("INSERT INTO gang_vault_log (gang_id, user_id, type, added, balance) VALUES (?, ?, 'points', ?, ?)", [$gang_class->id, $user_class->id, $amount, $gang_class->pointsvault]);
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                <div class="card text-white" style="background-color: #292929;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Current Balance:<span
                                style="color:red"><?php echo prettynum($gang_class->moneyvault, 1); ?></span></h5>
                        <form method="post">
                            <div class="input-group">
                                <input type="text" name="damount" value="<?php echo $user_class->money; ?>" size="10"
                                    maxlength="20" placeholder="Amount to donate">
                                <button type="submit" name="deposit" style="margin-left: 10px;"
                                    class="btn btn-primary">Donate Money</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card text-white" style="background-color: #292929;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Current Points: <span
                                style="color:red"><?php echo prettynum($gang_class->pointsvault); ?></span></h5>

                        <form method="post">
                            <div class="input-group">
                                <input type="text" name="damount" value="<?php echo $user_class->points; ?>" size="10"
                                    maxlength="20" placeholder="Points to donate">
                                <button type="submit" name="deposit2" style="margin-left: 10px;"
                                    class="btn btn-primary">Donate Points</button>
                            </div>
                        </form>
                    </div>
                </div>
