                        ...
                        <div class="card-body">
                            <form method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="NumberOfSpins" value="<?= $user_class->slots_left1; ?>" maxlength="3">
                                </div>
                                <div class="mb-3">
                                    <label for="automoney" class="form-label">Bet</label>
                                    <input type="text" class="form-control" name="automoney" value="<?= $money; ?>" maxlength="4">
                                </div>
