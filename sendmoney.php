...
include 'header.php';
?>
<div class='box_top'>Send Money</div>
<div class='box_middle'>
    <div class='pad'>
        <?php
        if (isset($_POST['sendmoney']) && $_POST['sendmoney'] != "" && $user_class->level > 24) {
            // Verify integers
        ...
        if (isset($_POST['sendmoney2']) && $_POST['sendmoney2'] != "" && $user_class->level > 24) {
            $money_person = new User($_POST['theirid']);
            //Validate money
            $notallowed = array('$', '-', '_', '+', '=', '<', '>');
                ...
                <form name='login' method='post' action='sendmoney.php?person=<?php echo $_GET['person']; ?>'>
                    <table>
                        <tr>
                            ...
                            <td width='45%'>
                                <input name='amount' type='text' onKeyPress="return numbersonly(this, event)" size='9'
                                    value='<?php echo ($user_class->money > 1000000000) ? 1000000000 : $user_class->money; ?>'>&nbsp;&nbsp;$1,000,000,000
                                max.
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <input type="hidden" name="theirid" value="<?php echo $_GET['person']; ?>" /><input
                                    type='submit' name='sendmoney' value='Send Money'>
                            </td>
                        </tr>
                    </table>
                </form>
