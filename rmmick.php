    ...
    if ($_GET['buy'] == "limitedpack") {
        if ($user_class->limiteditems1 == 0) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems1` = limiteditems1 - 1 WHERE `limiteditems1` != '0'");
                         $db->query("UPDATE grpgusers SET  credits = credits - 200, points = points + 40000 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Standard Points Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 200 credits on your Standard Points Package!");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack2") {
        if ($user_class->limiteditems2 == 0) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems2` = limiteditems2 - 1 WHERE `limiteditems2` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 750000, bank = bank + 0, credits = credits - 2000 WHERE id = ?");

                $db->execute(array(
                               $user_class->id
            ));
            Give_Item(10, $user_class->id, 15);
            ...
            Send_Event($user_class->id, "You have been credited your Large Points Pack!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 2000 credits on your Large Points Pack.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack3") {
        if ($user_class->limiteditems3 == 0) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems3` = limiteditems3 - 1 WHERE `limiteditems3` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 10000000, credits = credits - 20000 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Extreme Points Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 20,000 credits on your Extreme Points Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
echo '<div id="pricing-table" class="clear">';
    echo '<div class="plan">';
             echo '<h5><font color=green>Standard Points Package</font></h5>'; //<span>200</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#000000">40,000 Points</span></b></li>';
 ...
 echo '<div class="plan">'; //id="most-popular"
         echo '<h5><font color=green>Large Points Pack</font></h5>';//<span>500</br>Credits</span>
        echo '<ul>';
           echo '<li><b><span style="color:#000000">750,000</span></b></li>';
        ...
        echo '<li><b><span style="color:#000000"> ' .  item_popup('Double Exp Pill', 10, 'green') . ' [x15]</span></b></li>';
        echo '</ul>';
...
echo '<div class="plan">';
        echo '<h5><font color=green>Mega Points Package</font></h5>'; //<span>750</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#000000">10,000,000 Points</span></b></li>';
