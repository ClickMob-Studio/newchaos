                        ...
                        <tr>
                            <td>
                                ...
                                <table class="top">
                                    <tr>
                                        <td align="right">
                                            <a href="news.php">News</a>&nbsp; | &nbsp;<a href="forum.php?id=8">Help Forum</a> &nbsp;|&nbsp; <a href="forum.php">Forums</a>&nbsp; |&nbsp; <a href="gameguide.php">Game Guide</a>&nbsp; | &nbsp;<a href="itempedia.php">Itempedia</a>&nbsp; |&nbsp; <a href="tickets.php">Support</a>&nbsp; |&nbsp; <a href="tos.php">TOS</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <table width='805' height="143px" border="0" style="table-layout:fixed; word-wrap:break-word;">
                                        ...
                                        <tr  valign="top">
                                            <td align="left" width="15%">
                                                ...
                                                ?>
                                                <a href='profiles.php?id=<?php echo $_SESSION['id'] ?>'><img height="115" width="115" style="border:1px solid #000000" src="<?php echo $avatar ?>"></a>
                                            </td>
                                            <td width="19%"><a href='profiles.php?id=<?php echo $_SESSION['id'] ?>'><?php echo $user_class->formattedname; ?></a><br />
                                                Level:
                                                <!_-level-_!>
                                                <br />
                                                Money: $<!_-money-_!><br />
                                                <a href="bank.php?dep=<!_-money2-_!>">Bank</a>: $<?php echo prettynum($user_class->bank); ?><br />
                                                Points:
                                                <!_-points-_!><br />
                                                Credits:
                                                <!_-credits-_!>
                                                <br />[<a href = "spendpoints.php">Use</a>] [<a href = "rmstore.php">Buy</a>]
                                            </td>
                                            <td width="36%"></td>
                                            <td width="30%">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="95%">
                                                            <div class="bar_a" title="<!_-formexp-_!>">
                                                                <div class="bar_b" style="width: <!_-expperc-_!>%;" title="<!_-formexp-_!>">&nbsp;</div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <tr><td>
                                <table class='topbar'>
                                    <tr>
                                        ...
                                        <td align="right">
                                            <a href="vote.php">Vote</a> | <a href="userpoll.php">Poll</a> | <a href="refer.php">Refer</a> | <a href="rmstore.php">Upgrade Account</a> | <a href="gameevents.php">Game Events</a>
                                        </td>
                                    </tr>
                                </table>
                                <?php
...
//END
                                                            if ($user_class->voted1 == 0 || $user_class->voted2 == 0 || $user_class->voted3 == 0 || $user_class->voted4 == 0 || $worked123['news'] == 1 || $user_class->gameevents == 0 || $user_class->polled1 == 0 && $user_class->polled1active == "active" || mysql_num_rows($resultginvite) > 0 || mysql_num_rows($resultrelation) > 0 || $user_class->hospital > 0 || $user_class->jail > 0 || $user_class->protectionact > time() || $user_class->drugused > 0 || $unifinished == 1 || $gcfinished == 1 || $warfinished == 1) {
                                                                ?>
                                                                <tr><td class='contentspacer'></td></tr><tr><td class='contenthead'>Important Message</td></tr>
                                                                <tr><td class='contentcontent'>
                                                                        <?php
