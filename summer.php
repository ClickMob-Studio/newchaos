...
<div class="floaty">
    ...
    <p class="text-14">Earn <?php echo item_popup('Rayz', 159, '#7eff11') ?> based on your activity level</p>
        <img src='https://themafialife.com/css/images/NewGameImages/rayz.png' width="100px">
    <div style="text-align:left;padding:10px;">
        <p class="text-14"><?php echo item_popup('Rayz', 159, '#7eff11') ?> will appear in your inventory and you can share with another player - you will both receive a random reward (same for both).</p>
        ...
        <p class="text-14">So the more active you are the more <?php echo item_popup('Rayz', 159, '#7eff11') ?> you will earn - make sure to share those Rayz!!</p>
