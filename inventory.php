...
$restrictedUseItems = array(68, 69, 155, 195, 156, 157, 194, 158, 159, 165, 167, 285, 295, 231, 230);
...
$multiUseItems = array(252, 253, 42, 10, 163, 256, 283, 251, 279, 281, 288, 289);  // Items allowing multiple uses
...
<div class="container-fluid my-4">
    ...
    function renderCategory($categoryName, $items, $loaned)
    {
        ...
        foreach ($items as $item) {
            ...
            if (in_array($item['id'], [336, 337, 338])) { // Easter Eggs
                ...
                $buttonHtml .= '<a href="travel.php" class="use-btn btn btn-sm btn-primary mt-2" data-item-id="' . $item['id'] . '" data-item-name="' . htmlspecialchars($itemName) . '">Travel</a>';
