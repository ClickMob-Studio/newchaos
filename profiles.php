...
$(document).ready(function() {
    ...
    setInterval(function() {
        ...
        <div style='width:100%;text-align:center;'>
            ...
            $ganginvite = !empty($user_rank) && isset($user_rank->invite) && ($user_rank->invite == 1) ? "<a href='profiles.php?id=$profile_class->id&action=ganginvite'>Invite to $gang->name</a>" : "None";
...
//    "<br>".$houseImage.
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="card"
                            ...
                            <div class="card-body">
                                <div class="profile-container d-flex justify-content-around">
                                    <div class='profile-package shadow-sm p-3 mb-5 bg-body rounded'
                                        style='flex: 1; margin: 5px;'>
                                        <div style="text-align: center;">
                                            <img src='<?php echo $profile_class->avatar; ?>' class='img-thumbnail'
                                        ...
                                        <div class="text-center p-2" style="background-color: #111; color: white;">Type:
                                        </div>
                                        <div class="text-center p-2"><?php echo $profile_class->type; ?></div>
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                            Location:</div>
                                        <div class="text-center p-2"> <a href='travel.php'><?php echo $city; ?></a>
                                        </div>
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                            Relationship:</div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card"
                            style="margin: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.2) !important; background: rgba(0,0,0,0.2);">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                    ...
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                            Busts:</div>
                                        <div class="text-center p-2"><?php echo prettynum($profile_class->busts); ?>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">Gang:
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                            Money:</div>
                                        <div class="text-center p-2">$<?php echo prettynum($profile_class->money); ?>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">Age:
                                        </div>
                                        <div class="text-center p-2"><?php echo $profile_class->age; ?></div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">Kills
                                            / Deaths:</div>
                                        <div class="text-center p-2"><?php echo prettynum($profile_class->battlewon); ?>
                                            / <?php echo prettynum($profile_class->battlelost); ?></div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                            Missions:</div>
                                        <div class="text-center p-2"><?php echo $profile_class->mission_count; ?></div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-2" style="background-color: #111; color: white;">
                                            Raids:</div>
                                        <div class="text-center p-2"><?php echo prettynum($profile_class->raidwins); ?>
                                        </div>
                                    </div>
                                    <div class="col-6">
        ...
        <div class='actions_grid'>
            ...
            <a class='action ajax-link' href='ajax_attack_v2.php?attack=" . $profile_class->id . "&csrf=" . $csrf . "'>Attack</a>
            ...
            <div class="profile-container mt-5"
                style="flex: 1; padding: 18px; box-shadow: 0 0 10px rgba(0,0,0,0.5); margin: 5px; background: rgba(0,0,0,0.2);">
                <div class="container">
                    <div class="row mb-3"
                        style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">
                    ...
                    <div class="row mb-2">
                        <div class="col-6"
                            style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">Gender:
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-6"
                            style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">User HP:
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-6"
                            style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">Back Alley
                            Wins:</div>
                    ...
                    <div class="row mb-2">
                        <div class="col-6"
                            style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">Busts:
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-6"
                            style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">Jobs:</div>
                    ...
                    <div class="row mb-2">
                        <div class="col-6"
                            style="background-color: #111; color: white; padding: 10px; border-radius: 5px;">Location:
                        </div>
...
.action:hover {
            ...
            foreach ($questSeasons as $questSeason) {
                ...
                if ($userQuestSeason && isset($userQuestSeason['id']) && $userQuestSeason['is_complete']) {
                    ...
                    <div class='achievement' style='text-align: center;'>
                        <div title="<?php echo $questSeason['name'] ?>"><img width="100px"
                                src="css/images/NewGameImages/<?php echo $questSeason['medal'] ?>"></img></div>
   ...
   ";
    ...
    <div class='equipped_main padded row'>";
            ...
            if (isset($profile_class->pet)) {
                echo "<div class='col-4 col-md-3'>
                    <div class='equip_item'>
                    <div class='equip_item_img'>
                    <img src='" . $profile_class->pet->avi . "' width='100px' height='100px'>
                    </div>
                    <div class='equip_item_name'>" .
                    $profile_class->pet->formatName() .
                    "</div>
                    </div>
                    </div>";
            }
            ...
            if ($user_class->admin == 1 || $user_class->st == 1) {
                ...
                <td class="contenthead">Add as staff</td>
                <tr>
                    ...
                    <td class="contenthead">Add Upgrade Package</td>
                    <tr>
                        <td class="contentcontent">
                            <table width='80%'>
                                <tr>
                                        ...
                                        <td>
                                            <select name='admin_item_id'>
                                                ...
                                                foreach ($aditems as $aditem):
                                                    ?>
                                                    <option value="<?php echo $aditem['id'] ?>"><?php echo $aditem['itemname'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select><br />
            ...
            if ($user_class->admin == 1 || $user_class->gm == 1 || $user_class->fm == 1) {
                if ($profile_class->admin != 1 || $user_class->id != $profile_class->id) {
                    ...
                    <tr>
                        <td class="contenthead">Banning Options</td>
                    </tr>
                    <tr>
                        <td class="contentcontent">
                            <table width='100%'>
            ...
            if ($user_class->admin == 1 || $user_class->gm == 1 || $user_class->fm == 1) {
                ...
                <td class="contenthead">Player Notes</td>
                <tr>
                    <td class="contentcontent">
                        <table width="95%">
                            <form method="post">
            ...
            if ($user_class->admin == 1 || $user_class->gm == 1) {
                ...
                <td class="contenthead">Add/Change Flag</td>
                <tr>
                    <td class="contentcontent">
                                ...
                                <tr>
                                    <td width="30%">
                                        <select name="flag">
                                            ...
                                            <option
                                                value="http://fc03.deviantart.net/fs70/f/2013/054/c/1/cool_design_header_by_kotrla-d5vyamb.png">
                                                badass flag</option>
                                        </select>
                                    </td>
                                    <td width="20%">
            ...
            if ($user_class->admin == 1 || $user_class->gm == 1) {
                ...
                <td class="contenthead">Change Gang</td>
                <tr>
                    <td class="contentcontent">
                        <table width="50%" align="center">
                            <form method="post">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <?php if ($profile_class->eqweapon != 0): ?>
                                <img src='<?php echo $profile_class->weaponimg; ?>' alt='Equipped Weapon' width='100'
                                    height='100' style='border: 1px solid #01a9b8'><br>
                        ...
                        <div class="col-md-4">
                            <?php if ($profile_class->eqarmor != 0): ?>
                                <img src='<?php echo $profile_class->armorimg; ?>' alt='Equipped Armor' width='100' height='100'
                                    style='border: 1px solid #01a9b8'><br>
                        ...
                        <div class="col-md-4">
                            <?php if ($profile_class->eqshoes != 0): ?>
                                <img src='<?php echo $profile_class->shoesimg; ?>' alt='Equipped Shoes' width='100' height='100'
                                    style='border: 1px solid #01a9b8'><br>
...
";
                ...
                if (!empty($weapons)) {
                    ...
                    <td class="contenthead">Weapons</td>
                    <tr>
                        <td class="contentcontent">
                            <table width='100%'>
                                <tr>
                ...
                if (!empty($armor)) {
                    ...
                    <td class="contenthead">Armour</td>
                    <tr>
                        <td class="contentcontent">
                            <table width='100%'>
                                <tr>
                ...
                if (!empty($loaned)) {
                    ...
                    <td class="contenthead">Items Loaned From Your Gang</td>
                    <tr>
                        <td class="contentcontent">
                            <table width='100%'>
                                <tr>
                ...
                if (!empty($rares)) {
                    ...
                    <td class="contenthead">Rare Items</td>
                    <tr>
                        <td class="contentcontent">
                            <table width='100%'>
                                <tr>
            ...
            if ($user_class->admin == 1 || $user_class->gm == 1) {
                ...
                <td class="contenthead">Account Preferences</td>
                <tr>
                    <td class="contentcontent">
                            ...
                            <table width='100%' border='0'>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>" maxlength="16">&nbsp;<span style="font-size:10px;">Will NOT change
                                            your login name.</span>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>">&nbsp;<span style="font-size:10px;">Upload avatar to <a
                                                href="http://tinypic.com" title="Tinypic Image Hosting"
                                                target="_blank">Tinypic</a>.</span>
                                    </td>
                                </tr>
                                <tr>
                                <tr>
