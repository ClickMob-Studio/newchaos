...
if ($user_class->gang == 0) {
    if ($_POST['create'] != "") { // if they are wanting to start a new gang
        ...
        if ($error == "") { // if there are no errors, make the gang
            ...
            $gangid = $worked['id'];
            $result = mysql_query("UPDATE `grpgusers` SET `gang` = '$gangid', `money` = '" . $newmoney . "', `gangleader` = '1', `grank` = '1' WHERE `id`='" . $_SESSION['id'] . "'");
            $result = mysql_query("DELETE FROM `ganginvites` WHERE `playerid`='" . $user_class->id . "'");
...
<table id="newtables" style="width:100%;">
    ...
    <tr>
            <form method='post'>
                ...
                To create a gang it costs $500,000. If you don't have enough, or would like to join someone elses gang, check out the <a href="gang_list.php">Gang List</a> for other gangs to join.<br><br>
                <table width='100%'>
                    <tr>
