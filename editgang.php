...
echo "
            ...
            <tr>
                ...
                <td width='75%'><textarea name='desc2' cols='53' rows='7'>" . str_replace(array('<','>'), array('&lt;','&gt;'), $gang_class->publicpage) . "</textarea></td>
            </tr>
            <tr>
                <td width='25%'><b>Private Gang Page:</b><br />[<a href='bbcode.php'>BBCode</a>]</td>
                <td width='75%'><textarea name='desc' cols='53' rows='7'>" . str_replace(array('<','>'), array('&lt;','&gt;'), $gang_class->description) . "</textarea></td>
            </tr>
            <tr>
                <td width='25%'></td>
