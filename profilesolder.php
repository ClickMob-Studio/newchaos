...
<span style='margin: 0; line-height: 27px; text-transform: uppercase; font-size: 20px; text-align: left; text-indent: 25px;'><h4>Welcome to   <a href='profiles.php?id=" . $profile_class->id . "'>" . $profile_class->formattedname . "</a>'s Profile</h4></span>
	<table id='newtables' style='width:100%;'>
        <tr>
            <th width='10%'>Level:</td>
            <td width='30%'>
                " . $profile_class->level . $prestige . "
            </td>
...
.profile_header {
    padding: 10px;
    font-size: 18px;
    background-color: #333; /* Same as .floaty background */
    ...
    text-align: center; /* Centered text */
        ...
        if ($user_class->id != $profile_class->id) {
            ...
            <div class='actions_main padded'>
                ...
                <div class='action'><a href='sendgold.php?person=$profile_class->id'>Send <font color=yellow>GOLD</font></div>
