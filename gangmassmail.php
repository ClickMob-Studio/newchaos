    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                echo "<tr><td colspan='5' class='text-start'><label for='subject' class='form-label'>Subject:</label> <input type='text' class='form-control' name='subject' value='GANG MASS MAIL' /></td></tr>";
                echo "<tr><td colspan='5' class='text-start'><label for='msgtext' class='form-label'>Message:</label> <textarea class='form-control' rows='5' name='msgtext' id='textbox'></textarea></td></tr>";
