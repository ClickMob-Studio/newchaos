...
if (isset($_GET['buy'])) {
    ...
    if ($_GET['buy'] == "limitedpack") {
        if ($user_class->limiteditems1 == 0) {
        ...
        } else if ($user_class->credits >= 120) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems1` = limiteditems1 - 1 WHERE `limiteditems1` != '0'");
                         $db->query("UPDATE grpgusers SET  credits = credits - 120, points = points + 70000 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Standard Donation Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 120 credits on your Standard Package!");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack2") {
        if ($user_class->limiteditems2 == 0) {
            echo Message("This Pack Is No Longer Available.");
        } else if ($user_class->credits >= 1200) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems2` = limiteditems2 - 1 WHERE `limiteditems2` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 700000, bank = bank + 0, credits = credits - 1200 WHERE id = ?");
  ...
  Give_Item(42, $user_class->id, 10);
            ...
            Send_Event($user_class->id, "You have been credited your Itermidiate Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 1200 credits on your Booster Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack3") {
        if ($user_class->limiteditems3 == 0) {
            echo Message("This Pack Is No Longer Available.");
        } else if ($user_class->credits >= 12000) {
            $newcredit = $user_class->credits -= 12000;
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems3` = limiteditems3 - 1 WHERE `limiteditems3` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 9000000, credits = credits - 1200 WHERE id = ?");
  ...
  Give_Item(42, $user_class->id, 100);
            Give_Item(14, $user_class->id, 500);
            ...
            Send_Event($user_class->id, "You have been credited your Extreme Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 12,000 credits on your Extreme Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "freebie") {
        if ($user_class->claimed == 1) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `claimed` = 1 WHERE id = ?");
                         $db->query("UPDATE grpgusers SET  points = points + 5000, claimed = 1, credits = credits - 0, donate_token = donate_token + 1 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Free Package 5,000 Points & a Double Exp Pill!</br> You've also received a double donation token! <a href='rmstore.php'>Click Here To Spend them in our store!</a>.", $user_class->id);
            $db->execute(array());
            echo Message("Happy Levelling!. You have been credited 5,000 Points & a Double Exp Pill.</br> You've also received a double donation token! <a href='rmstore.php'>Click Here To Spend them in our store</a> ");
        } else {
...
echo '<input type="hidden" name="item_name" value="Donation to TheMafiaLife2">';
echo '<input id="notify_input" type="hidden" name="notify_url" value="https://s2.themafialife.com/ipn_credits.php">';
...
echo '<div id="pricing-table" class="clear">';
    echo '<div class="plan">';
             echo '<h5><font color=green>Standard Package</font></h5>'; //<span><s>300</s></br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#FFF000">70,000 Points</span></b></li>';


         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Double Exp Pill', 10, 'green') . ' [x1]</span></b></li>';

         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Mystery Boxes', 42, 'green') . ' [x1]</span></b></li>';

         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Medical Certificate', 14, 'green') . ' [x5]</span></b></li>';
        ...
        echo '</ul>';
            ...
            echo '<div class="price"> <img src="css/images/coin.png"><span>120</span></div>';

        echo '<a class="signup" href="?buy=limitedpack">Buy Now</a>';     echo '</div>';
 echo '<div class="plan">'; //id="most-popular"
         echo '<h5><font color=green>Booster Package</font></h5>';//<span></br>Credits</span>
        echo '<ul>';
           echo '<li><b><span style="color:#FFF000">700,000 Points</span></b></li>';

  

        echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Double Exp Pill', 10, 'green') . ' [x10]</span></b></li>';

         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Mystery Boxes', 42, 'green') . ' [x10]</span></b></li>';

         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Medical Certificate', 14, 'green') . ' [x50]</span></b></li>';
        ...
        echo '</ul>';
            ...
            echo '<div class="price"> <img src="css/images/coin.png"><span>1200</span> </div>';
        echo '<a class="signup" href="?buy=limitedpack2">Buy Now</a>';     echo '</div>';
echo '<div class="plan">';
        echo '<h5><font color=green>Extreme Package</font></h5>'; //<span>750</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#FFF000">9,000,000 Points</span></b></li>';

 
        echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Double Exp Pill', 10, 'green') . ' [x100]</span></b></li>';

         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Mystery Boxes', 42, 'green') . ' [x100]</span></b></li>';

         echo '<li><b><span style="color:#FFF000"> ' .  item_popup('Medical Certificate', 14, 'green') . ' [x500]</span></b></li>';
            ...
            echo '<div class="price"> <img src="css/images/coin.png"> <span>12000</span> </div>';
