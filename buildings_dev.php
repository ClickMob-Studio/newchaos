...
if (isset($_GET['buy'])) {
    ...
    if (empty($row)) diefun("Error, this building was not found.");        
    $cost = $row['cost'];
...
<div class="floaty flexcont" style="width:98%;">
    ...
    <div class="flexele" style="border-left:thin solid #333;">Food<br><br><?php echo isset($row['costfood']) && $row['costfood'] > 0 ? $row['costfood'] : 0; ?></div>
    <div class="flexele" style="border-left:thin solid #333;">Iron<br><br><?php echo isset($row['costiron']) && $row['costiron'] > 0 ? $row['costiron'] : 0; ?></div>
    <div class="flexele" style="border-left:thin solid #333;">Stone<br><br><?php echo isset($row['coststone']) && $row['coststone'] > 0 ? $row['coststone'] : 0; ?></div>
    <div class="flexele" style="border-left:thin solid #333;">Wood<br><br><?php echo isset($row['costwood']) && $row['costwood'] > 0 ? $row['costwood'] : 0; ?></div>
    <div class="flexele" style="border-left:thin solid #333;">Time<br><br><?php echo isset($row['costtime']) && $row['costtime'] > 0 ? $row['costtime'] : 0; ?></div>
