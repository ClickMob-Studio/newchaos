...
<div class="floaty">
    ...
    <div style="text-align:left;padding:10px;">
        <p class="text-14"><?php echo item_popup('Fireworks', 158, '#7eff11') ?> will appear in your inventory and you
        ...
        <p class="text-14">So the more active you are the more <?php echo item_popup('Fireworks', 158, '#7eff11') ?> you
            will earn - make sure to share those fireworks!!</p>
