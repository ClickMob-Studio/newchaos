...
class Am_LicenseChecker
{
    ...
    private $_local_encryption_key = '486212a745d25eca0479c3a831dad110f6bbd1be';
...
class Am_Crypt_Blowfish
{
    ...
    function encrypt($plainText)
    {
        ...
        if (function_exists('openssl_encrypt')) {
            $iv = str_repeat("\0", 8);
            return openssl_encrypt($plainText, 'BF-ECB', $this->_openssl_key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
        }
    ...
    function decrypt($cipherText)
    {
        ...
        if (function_exists('openssl_decrypt')) {
            $iv = str_repeat("\0", 8);
            return openssl_decrypt($cipherText, 'BF-ECB', $this->_openssl_key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
        }
