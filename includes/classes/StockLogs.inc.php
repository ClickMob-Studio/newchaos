<?php
     ...
     */
    final class StockLogs extends BaseObject
    {
        public static $idField = 'log_id'; //id field
        public static $dataTable = 'stocklogs'; // table implemented
        ...
        {
            $objs = [];
            $query = 'SELECT stocklogs.*, company_name FROM stocklogs , stocks WHERE stocklogs.stock_id = stocks.id AND user_id = \'' . $user_id . '\' ORDER BY stocklogs.time DESC';
