...
class UploadProgressManager
{
    ...
    public function __checkSentinell(&$phptempfiles)
    {
        $found = false;
    ...
    public function __getPersonalFile(&$tmpfolder, &$pattern)
    {
        $found = false;
        if (is_dir($tmpfolder)) {
     ...
     */
    public function UploadProgressManager($tmpfolder, $pattern = '/[p][h][p]*')
    {
     ...
     */
    public function getTemporaryFileSize()
    {
