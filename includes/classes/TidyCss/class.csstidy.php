...
class csstidy
{
     ...
     * @version 1.0
     */
    public function set_cfg($setting, $value)
    {
    ...
    public function parse($string)
    {
        ...
        for ($i = 0, $size = strlen($string); $i < $size; ++$i) {
            ...
            if (csstidy::is_token($string, $i)) {
                ...
                elseif (!($string[$i] == '*' && @in_array($string[$i + 1], ['.', '#', '[', ':']))) {
            ...
            if ($string[$i] == $this->str_char && !csstidy::escaped($string, $i) && !$this->str_in_str) {
                ...
                if (!preg_match('|[' . implode('', $GLOBALS['csstidy']['whitespace']) . ']|uis', $this->cur_string) && $this->property != 'content') {
                    ...
                    } elseif (strlen($this->cur_string) > 3 && ($this->cur_string[1] == '"' || $this->cur_string[1] == '\'')) /* () */ {
