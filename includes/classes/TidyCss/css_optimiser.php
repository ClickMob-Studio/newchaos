...
if (!isset($_REQUEST['rbs']) && isset($_REQUEST['post'])) {
    $css->set_cfg('remove_bslash', false);
}
if (isset($_REQUEST['preserve_css'])) {
    $css->set_cfg('preserve_css', true);
}
if (isset($_REQUEST['sort_sel'])) {
    $css->set_cfg('sort_selectors', true);
}
if (isset($_REQUEST['sort_de'])) {
    $css->set_cfg('sort_properties', true);
}
if (isset($_REQUEST['remove_last_sem'])) {
    $css->set_cfg('remove_last_;', true);
}
if (isset($_REQUEST['discard'])) {
    $css->set_cfg('discard_invalid_properties', true);
}
if (isset($_REQUEST['css_level'])) {
    $css->set_cfg('css_level', $_REQUEST['css_level']);
}
    ...
    <form method="post" action="">
      <div>
        <fieldset id="field_input">
          ...
          class="block"><?php echo $lang[$l][9]; ?></label><textarea id="css_text" name="css_text" rows="20" cols="35"><?php if (isset($_REQUEST['css_text'])) {
    echo htmlspecialchars($_REQUEST['css_text']);
} ?></textarea>
            <label for="url"><?php echo $lang[$l][10]; ?></label> <input type="text"
          name="url" id="url" <?php if (isset($_REQUEST['url']) &&
          !empty($_REQUEST['url'])) {
    echo 'value="' . $_REQUEST['url'] . '"';
} ?>
          size="35"><br>
        ...
        <div id="rightcol">
         ...
         <legend><?php echo $lang[$l][19]; ?></legend>
            ...
            <input onchange="enable_disable_preserve()" type="checkbox" name="preserve_css" id="preserve_css"
                   <?php if ($css->get_cfg('preserve_css')) {
            ...
            <input type="checkbox" name="sort_sel" id="sort_sel"
                   <?php if ($css->get_cfg('sort_selectors')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" name="sort_de" id="sort_de"
                   <?php if ($css->get_cfg('sort_properties')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" name="compress_c" id="compress_c"
                   <?php if ($css->get_cfg('compress_colors')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" name="compress_fw" id="compress_fw"
                   <?php if ($css->get_cfg('compress_font-weight')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" name="lowercase" id="lowercase" value="lowercase"
                   <?php if ($css->get_cfg('lowercase_s')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" id="remove_last_sem" name="remove_last_sem"
                   <?php if ($css->get_cfg('remove_last_;')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" id="discard" name="discard"
                   <?php if ($css->get_cfg('discard_invalid_properties')) {
                   echo 'checked="checked"';
               } ?>>
            ...
            <input type="checkbox" name="file_output" id="file_output" value="file_output"
                   <?php if (isset($_REQUEST['file_output'])) {
                   echo 'checked="checked"';
               } ?>>
