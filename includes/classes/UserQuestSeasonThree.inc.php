...
class UserQuestSeasonThree extends CachedObject
{
    public static $dataTable = 'user_quest_season_three';
    ...
    {
        return new UserQuestSeasonThree($id);
    }
    ...
    public function startNextMission()
    {
        ...
        if ($this->current_mission == 6) {
            $requirements = array(
                'cure_vials_collected' => array(
                    'required' => 15,
                    'complete' => 0
                ),
                'fungal_subjects_beaten' => array(
                    'required' => 5,
                    'complete' => 0
                )
            );
    ...
    public static function getRequirementKeyForDisplay($key)
    {
        $displays = array(
            ...
            'cure_vials_collected' => 'Cure Vials Collected',
            'fungal_subjects_beaten' => 'Fungal Subjects Beaten',
            'fungal_vial_attacks' => 'Complete 25 attacks on soldiers who are impacted by fungal vials',
        );
