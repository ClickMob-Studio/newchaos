...
class RPStoreNew
{
    ...
    public function __construct()
    {
        ...
        */
        ...
        /*$item = new RPItemNew(300);
        $item->setCode('Special Pack');
        $item->setName('60 ' . DPRPSTORE_AWAKE_PILLS);*/

        $item = new RPItemNew(250);
     ...
     * @param string $cat
     */
    public function addItem(RPItemNew $item, $cat = 'store')
    {
