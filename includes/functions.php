...
function formatName($id, $nogang = 0)
{
    ...
    if ($row['prestige'] > 0) {
        ...
        if ($row['prestige'] >= 10) {
            ...
            if ($skull !== false) {
                $name .= " <img src='images/skullpres_" . $skull . ".png?v=1' title='Prestige ({$row['prestige']})' height='24' width='24' />";
            } else {
                $name .= " <img src='images/skullpres_" . $row['prestige'] . ".png?v=1' title='Prestige ({$row['prestige']})' height='24' width='24' />";
            }
        } else {
            $name .= " <img src='images/skullpres_" . $row['prestige'] . ".png?v=1' title='Prestige ({$row['prestige']})' height='24' width='24' />";
        }
