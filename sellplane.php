...
if ($_GET['id'] == "") {
    ...
    echo Message("No airplane picked.");
...
$howmany = Check_Plane($_GET['id'], $user_class->id);//check how many they have


$result2 = mysql_query("SELECT * FROM `planes` WHERE `id`='" . $_GET['id'] . "'");
