<?php
include 'header.php';
$result = mysql_query("SELECT * FROM `rmstore` WHERE `limiteditems1` != '9999'");
...
if (isset($_GET['buy'])) {
    ...
    if ($_GET['buy'] == "limitedpack") {
        if ($user_class->limiteditems1 == 0) {
        ...
        } else if ($user_class->credits >= 200) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems1` = limiteditems1 - 1 WHERE `limiteditems1` != '0'");
                         $db->query("UPDATE grpgusers SET  credits = credits - 200, points = points + 30000 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Standard Police Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 200 credits on your Standard Police Package!");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack2") {
        if ($user_class->limiteditems2 == 0) {
            echo Message("This Pack Is No Longer Available.");
        } else if ($user_class->credits >= 2000) {
            $newcredit = $user_class->credits -= 2000;
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems2` = limiteditems2 - 1 WHERE `limiteditems2` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 500000, bank = bank + 0, credits = credits - 2000 WHERE id = ?");
            ...
            Give_Item(10, $user_class->id, 5);
                                             ...
                                             Give_Item(163, $user_class->id, 10);
            ...
            Send_Event($user_class->id, "You have been credited your Large Police Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 2000 credits on your Large Police  Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "limitedpack3") {
        if ($user_class->limiteditems3 == 0) {
            echo Message("This Pack Is No Longer Available.");
        } else if ($user_class->credits >= 20000) {
            $newcredit = $user_class->credits -= 20000;
            $result    = mysql_query("UPDATE `grpgusers` SET `limiteditems3` = limiteditems3 - 1 WHERE `limiteditems3` != '0'");
                         $db->query("UPDATE grpgusers SET  points = points + 8000000, credits = credits - 20000 WHERE id = ?");
                ...
                $db->execute(array(
                               $user_class->id
                                              ...
                                              Give_Item(10, $user_class->id, 40);
                                             Give_Item(8, $user_class->id, 40);

                                             Give_Item(9, $user_class->id, 50);
                                             Give_Item(163, $user_class->id, 125);
            ...
            Send_Event($user_class->id, "You have been credited your Extreme Police Package!.", $user_class->id);
            $db->execute(array());
            echo Message("You spent 20,000 credits on your Extreme Summer Package.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
if ($_GET['buy'] == "freebie") {
        if ($user_class->claimed == 1) {
            ...
            $result    = mysql_query("UPDATE `grpgusers` SET `claimed` = 1 WHERE id = ?");
                         $db->query("UPDATE grpgusers SET  points = points + 5000, claimed = 1, credits = credits - 0 WHERE id = ?");
            ...
            Send_Event($user_class->id, "You have been credited your Free Package 5,000 Points & a Double Exp Pill!.", $user_class->id);
            $db->execute(array());
            echo Message("Happy Levelling!. You have been credited 5,000 Points & a Double Exp Pill.");
        } else {
    ...
    if ($_GET['buy'] == "ip") {
        if ($user_class->credits >= 280) {
            ...
            echo Message("You spent 190 credits for the intermediate pack.");
        } else {
            echo Message("You don't have enough credits. You can buy some at the upgrade store.");
        }
    }
...
//echo '<center><font color=white>Example: Donate $3.00 Recieve 30 Credit(s)</font></center>';
...
echo '<center><form id="payForm" action="https://www.paypal.com/cgi-bin/webscr" method="post" target=_blank class="style8"></center>';
echo '<center>Donation: <input id="donate-input" type="text" size="4" name="amount" min="3" value="3"/> (USD)</center>';
echo 'Reward: <span id="credits" class="text-yellow">30 Credits</span><br/>';
if ($user_class->donate_token > 0) {
    echo '<label><input type="checkbox" name="on0" value="1" id="boost"><span>Use Boost Token</span></label><br/><br/>';
}
echo '<input type="hidden" name="cmd" value="_xclick">';
echo '<input type="hidden" id="user" name="user" value="' . $user_class->id . '">';
echo '<input type="hidden" name="currency_code" value="USD">';
echo '<input type="hidden" id="custom" name="custom" value="0,' . $user_class->id . '">';
echo '<input type="hidden" name="business" value="excelledgaming@outlook.com">';
echo '<input type="hidden" name="item_number" value="1">';
echo '<input type="hidden" name="item_name" value="Donation to TheMafiaLife">';
echo '<input id="notify_input" type="hidden" name="notify_url" value="https://themafialife.com/ipn_credits.php">';
echo '<center><input id="donate-btn" type="image" width="190px" height="60px" src="css/images/donate-now-button.png" border="0" name="submit"></center>';
echo '</form>';
echo'<br>';
...
echo '<div id="pricing-table" class="clear">';
    echo '<div class="plan">';
             echo '<h5><font color=green>Standard Summer Package</font></h5>'; //<span>200</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#000000">30,000 Points</span></b></li>';

  echo '<li><b><span style="color:#000000"><img src="https://themafialife.com/css/images/NewGameImages/badge.png" width="100px"></br> <b><span style="color:#000000"> ' .  item_popup('Police Badge', 163, 'yellow') . ' [x1]</span></b></span></b></li>';


            echo '<li><b><span style="color:#000000"> ' .  item_popup('Attack Protection', 9, 'green') . ' [x1]</br> ' .  item_popup('Mug Protection', 8, 'green') . ' [x1] </span></b></li>';
 ...
 echo '<div class="plan">'; //id="most-popular"
         echo '<h5><font color=green>Large Police Package</font></h5>';//<span>500</br>Credits</span>
        echo '<ul>';
           echo '<li><b><span style="color:#000000">500,000 Points</span></b></li>';

  echo '<li><b><span style="color:#000000"><img src="https://themafialife.com/css/images/NewGameImages/badge.png" width="100px"></br> <b><span style="color:#000000"> ' .  item_popup('Police Badge', 163, 'yellow') . ' [x10]</span></b></span></b></li>';


            echo '<li><b><span style="color:#000000"> ' .  item_popup('Attack Protection', 9, 'green') . ' [x10]</br> ' .  item_popup('Mug Protection', 8, 'green') . ' [x10] </span></b></li>';
        ...
        echo '</ul>';
            ...
            echo '<div class="price"> <img src="css/images/coin.png"><span> 2000</span> </div>';
        echo '<a class="signup" href="?buy=limitedpack2">Buy Now</a>';     echo '</div>';
echo '<div class="plan">';
        echo '<h5><font color=green>Mega Police Package</font></h5>'; //<span>750</br>Credits</span>
        echo '<ul>';
            echo '<li><b><span style="color:#000000">8,000,000 Points</span></b></li>';
  echo '<li><b><span style="color:#000000"><img src="https://themafialife.com/css/images/NewGameImages/badge.png" width="100px"></br> <b><span style="color:#000000"> ' .  item_popup('Police Badge', 163, 'yellow') . ' [x125]</span></b></span></b></li>';
     echo '<li><b><span style="color:#000000"> ' .  item_popup('Attack Protection', 9, 'green') . ' [x40]</br> ' .  item_popup('Mug Protection', 8, 'green') . ' [x40] </span></b></li>';

        echo '<li><b><span style="color:#000000"> ' .  item_popup('Double Exp Pill', 10, 'green') . ' [x50]</span></b></li>';



               echo '</ul>';
            echo '<li><b><span style="color:#000000">' . $user_class->limiteditems3 . ' / 5 Remaining</span></b></li>';
            echo '<div class="price"> <img src="css/images/coin.png"> <span>20000</span> </div>';
...
if (!$user_class->id < 10000) {
    echo '<table id="newtables" class="donate" style="width:100%;">';
    echo '<tr>';
    ...
    echo '<th colspan="100" align="center">Respected Mobster Upgrades</th>';
    echo '</tr>';
    echo '<tr>';
    echo '<td>&nbsp;</td>';
    ...
    echo '<td id="dottedRow"><img src="css/images/coin.png"><font size="3" color="yellow"><b>&nbsp;30</b></font></td>';
    echo '<td id="dottedRow"><img src="css/images/coin.png"><font size="3" color="yellow"><b>&nbsp;60</b></font></td>';
    echo '<td id="dottedRow2"><img src="css/images/coin.png"><font size="3" color="yellow"><b>&nbsp;90</b></font></td>';
    echo '</tr>';
    echo '<tr>';
    echo '<td id="dottedRow7">&nbsp;</td>';
    echo '<td id="dottedRow5">&nbsp;</td>';
    echo '<td id="dottedRow5"><a class="cta" href="?buy=rm30">[Buy Now]</a></td>';
    echo '<td id="dottedRow5"><a class="cta" href="?buy=rm60">[Buy Now]</a></td>';
    echo '<td id="dottedRow6"><a class="cta" href="?buy=rm90">[Buy Now]</a></td>';
    echo '</tr>';
    echo '</table>';
}
echo '</br>';
