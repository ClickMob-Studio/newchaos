...
<ul>
    <li>Personal identifiers, contacts and characteristics (for example, email, IP address) at signup and during play.</li>
    <li>Contact details such as email, name, address for the purposes of tracking in-game payments.</li>
</ul>
<h2>How we get the personal information and why we have it</h2>
<p>All of the personal information we process is provided to us directly by you for one of the following reasons:</p>
<ul>
    <li>To sign up and continue to use Chaos City.</li>
    <li>To purchase in-game services.</li>
    <li>To sign up to marketing-related communications.</li>
</ul>
<p>We use the information that you have given us in order to:</p>
<ul>
    <li>Provide access to Chaos City and all functionality within the service.</li>
    <li>Verify login credentials.</li>
    <li>Email you when required.</li>
</ul>
...
<ul>
    <li>Your consent. You are able to remove your consent at any time. You can do this by contacting <a href="mailto:admin@chaoscity.co.uk">admin@chaoscity.co.uk</a>.</li>
...
<p>We keep personal and game-related data for the lifetime of the account to ensure continued access to Chaos City.</p>
<p>If an account is deleted or such a request is received by the primary email associated with an account we will dispose of personally identifiable information within 4 weeks of taking receipt of said request.</p>
...
<p>Please contact us at <a href="mailto:admin@chaoscity.co.uk">admin@chaoscity.co.uk</a> if you wish to make a request.</p>
<h2>How to complain</h2>
<p>If you have any concerns about our use of your personal information, you can make a complaint to us at <a href="mailto:admin@chaoscity.co.uk">admin@chaoscity.co.uk</a></p>
